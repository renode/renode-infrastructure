...
namespace Antmicro.Renode.Peripherals.MTD
{
    ...
    {
        public static void CFIFlashFromFile(this Machine machine, string fileName, long whereToRegister, string name, SysbusAccessWidth busWidth = SysbusAccessWidth.DoubleWord, bool nonPersistent = false, int? size = null)
        {
            CFIFlash flash;
            try
            {
