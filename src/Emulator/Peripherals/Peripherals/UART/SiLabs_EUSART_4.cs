...
namespace Antmicro.Renode.Peripherals.UART
{
    ...
    public class SiLabs_EUSART_4 : UARTBase, IUARTWithBufferState, IDoubleWordPeripheral, IPeripheralContainer<ISPIPeripheral, NullRegistrationPoint>
    {
        ...
        private DoubleWordRegisterCollection BuildRegistersCollection()
        {
            var registerDictionary = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.IrHfCfg, new DoubleWordRegister(this)
                 ...
                 {(long)Registers.TimingCfg, new DoubleWordRegister(this)
                    .WithTag("TXDELAY", 0, 2)
        ...
        private readonly bool LogRegisterAccess = true;
