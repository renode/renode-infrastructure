...
{
    public partial class SiLabs_TIMER_1
    {
        public SiLabs_TIMER_1(Machine machine) : base(machine)
        {
            SiLabs_TIMER_1_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Timers
{
    public partial class SiLabs_TIMER_1 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_TIMER_1(Machine machine) : base(machine)
        {
            Define_Registers();
    ...
    protected IEnumRegisterField<CC_CTRL_ICEVCTRL>[] cc_ctrl_icevctrl_field = new IEnumRegisterField<CC_CTRL_ICEVCTRL>[3];
        ...
        partial void SiLabs_TIMER_1_Constructor();
