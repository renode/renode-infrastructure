...
{
    public partial class Emu_3
    {
        public Emu_3(Machine machine) : base(machine)
        {
            Emu_3_constructor();
        }
    }
...
namespace Antmicro.Renode.Peripherals.Silabs
{
    public partial class Emu_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public Emu_3(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void Emu_3_Constructor();
