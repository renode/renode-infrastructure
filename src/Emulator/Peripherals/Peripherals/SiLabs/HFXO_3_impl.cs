...
using Antmicro.Renode.Peripherals.Silabs;

namespace Antmicro.Renode.Peripherals.Silabs
{
    // Allows for the viewing of register contents when debugging
    [AllowedTranslations(AllowedTranslation.ByteToDoubleWord)]
    public partial class Hfxo_3 : IHfxo
    {
        public Hfxo_3(Machine machine, uint startupDelayTicks) : this(machine)
        {
        ...
        partial void Hfxo_3_Constructor()
        {
