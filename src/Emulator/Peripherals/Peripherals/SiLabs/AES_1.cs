...
{
    public class AES_1 : IDoubleWordPeripheral, IKnownSize
    {
        public AES_1(Machine machine)
        {
...
#region methods
        ...
        private void StartFetcher()
        {
            ...
            {
                throw new NotSupportedException("START_FETCHER: direct mode not supported");
            }
