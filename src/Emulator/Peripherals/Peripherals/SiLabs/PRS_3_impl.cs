...
namespace Antmicro.Renode.Peripherals.Silabs
{
    ...
    public partial class Prs_3 : IPrs
    {
        partial void Prs_3_Constructor()
        {
        ...
        private ISysrtc _sysrtc;
        public ISysrtc sysrtc
        {
            get
            {
                if (Object.ReferenceEquals(_sysrtc, null))
                {
                    foreach(var sysrtc in machine.GetPeripheralsOfType<ISysrtc>())
                    {
                        _sysrtc = sysrtc;
                    }
                }
        ...
        public IHfxo hfxo
        {
            get
            {
                ...
                {
                    foreach(var hfxo in machine.GetPeripheralsOfType<IHfxo>())
                    {
                        _hfxo = hfxo;
                    }
                }
        ...
        // An enum to be used in place of ASYNC_CH_CTRL_SIGSEL (from prs_3_gen.cs) for the Sigsel bitfields in
