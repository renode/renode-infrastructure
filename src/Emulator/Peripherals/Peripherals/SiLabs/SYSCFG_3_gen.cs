...
{
    public partial class Syscfg_3
    {
        public Syscfg_3(Machine machine) : base(machine)
        {
            Syscfg_3_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Silabs
{
    public partial class Syscfg_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public Syscfg_3(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void Syscfg_3_Constructor();
