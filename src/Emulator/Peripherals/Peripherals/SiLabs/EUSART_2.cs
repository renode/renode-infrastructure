...
namespace Antmicro.Renode.Peripherals.Silabs
{
    ...
    public class EUSART_2 : UARTBase, IUARTWithBufferState, IDoubleWordPeripheral, IPeripheralContainer<ISPIPeripheral, NullRegistrationPoint>
    {
        public EUSART_2(Machine machine, uint clockFrequency = 19000000) : base(machine)
        {
