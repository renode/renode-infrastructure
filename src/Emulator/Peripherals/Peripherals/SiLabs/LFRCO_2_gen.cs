...
{
    public partial class Lfrco_2
    {
        public Lfrco_2(Machine machine) : base(machine)
        {
            Lfrco_2_constructor();
        }
    }
...
namespace Antmicro.Renode.Peripherals.Silabs
{
    public partial class Lfrco_2 : BasicDoubleWordPeripheral, IKnownSize
    {
        public Lfrco_2(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void Lfrco_2_Constructor();
