...
{
    public partial class Hfrco_2
    {
        public Hfrco_2(Machine machine) : base(machine)
        {
            Hfrco_2_constructor();
        }
    }
...
namespace Antmicro.Renode.Peripherals.Silabs
{
    public partial class Hfrco_2 : BasicDoubleWordPeripheral, IKnownSize
    {
        public Hfrco_2(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void Hfrco_2_Constructor();
