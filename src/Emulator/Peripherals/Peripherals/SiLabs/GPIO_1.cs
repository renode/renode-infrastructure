...
{
    public class GPIO_1 : BaseGPIOPort, IDoubleWordPeripheral, IKnownSize
    {
        public GPIO_1(Machine machine, bool logRegisterAccess = false) : base(machine, NumberOfPins * NumberOfPorts)
        {
