...
namespace Antmicro.Renode.Peripherals.SiLabs
{
    ...
    public class LockbitsData : IDoubleWordPeripheral, IKnownSize
    {
        public LockbitsData(uint size, 
        ...
        public uint ReadDoubleWord(long offset)
        {
            if ((offset & 0x3) > 0)
            {
                throw new Exception("ReadDoubleWord: Offset must be a multiple of 4");
            }
        ...
        public void WriteDoubleWord(long offset, uint value)
        {
            if ((offset & 0x3) > 0)
            {
                throw new Exception("WriteDoubleWord: Offset must be a multiple of 4");
            }
