...
namespace Antmicro.Renode.Peripherals.Silabs
{
    ...
    public partial class Timer_1
    {
        public Timer_1(Machine machine, uint frequency, int width) : this(machine)
        {
        ...
        partial void Timer_1_Constructor()
        {
        ...
        private void RestartTimer(bool restartFromZero = false)
        {
            ...
            timer.Limit = limit;
            this.Log(LogLevel.Info, "Set timer limit to {0}", timer.Limit);
            timer.Enabled = true;
