...
namespace Antmicro.Renode.Peripherals.Silabs
{
    ...
    public class USART_0 : UARTBase, IUARTWithBufferState, IDoubleWordPeripheral, IPeripheralContainer<ISPIPeripheral, NullRegistrationPoint>
    {
        public USART_0(Machine machine, uint clockFrequency) : base(machine)
        {
