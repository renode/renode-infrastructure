...
{
    public class Semailbox_1 : IDoubleWordPeripheral, IKnownSize
    {
        public Semailbox_1(Machine machine)
        {
            ...
            secureElement = new SecureElement(machine, this, txFifo, rxFifo, false);
...
#region fields
        ...
        private readonly SecureElement secureElement;
