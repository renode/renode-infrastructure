...
namespace Antmicro.Renode.Peripherals.SPI.Cadence_xSPICommands
{
    ...
    internal class DataSequenceCommand : STIGCommand, IDMACommand
    {
           ...
           : base(controller, payload)
        {
            ...
            statusDataSource = BitHelper.IsBitSet(payload[1], 24);
        ...
        public override void Transmit()
        {
            ...
            if(DMADataCount <= 2 && statusDataSource && DMADirection == TransmissionDirection.Read)
            {
        ...
        private readonly bool statusDataSource;
