...
namespace Antmicro.Renode.Peripherals.SPI
{
        ...
        IDoubleWordPeripheral, IProvidesRegisterCollection<DoubleWordRegisterCollection>, IPeripheral, IKnownSize
    {
        ...
        private void IncomingFifoCountChangeAction(Fifo fifo, uint previousCount, uint currentCount)
        {
        ...
        private void OutgoingFifoCountChangeAction(Fifo fifo, uint previousCount, uint currentCount)
        {
        ...
        private class Fifo
        {
            ...
            private uint Count
            {
                ...
                set
                {
                    ...
                    count = value;
                    CountChangeAction?.Invoke(this, previousCount, count);
                }
            }
