...
namespace Antmicro.Renode.Peripherals.Sound
{
    ...
    {
        public LiteX_I2S_Master(Machine machine, DataFormat format, uint sampleWidthBits, uint samplingRateHz, uint numberOfChannels) : base(machine, format, sampleWidthBits, samplingRateHz, 24)
        {
        ...
        protected override void QueueFilled()
        {
            TryDequeueSample(out var sample);
