...
{
    public partial class SiLabs_EMU_3
    {
        public SiLabs_EMU_3(Machine machine) : base(machine)
        {
            SiLabs_EMU_3_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_EMU_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_EMU_3(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_EMU_3_Constructor();
