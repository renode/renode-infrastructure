...
/*  WARNING: Auto-Generated Peripheral  -  DO NOT EDIT
    HFRCO, Generated on : 2025-05-08 15:30:19.942260
    HFRCO, ID Version : 165adedf604742fda856a08648e115e5.3 */
...
{
    public partial class SiLabs_HFRCO_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        // Cal - Offset : 0x8
        protected DoubleWordRegister GenerateCalRegister() => new DoubleWordRegister(this, 0xA60307DB)
            
            .WithValueField(0, 6, out cal_tuning_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(6, 6, out cal_finetuning_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(12, 3, out cal_bandcoarse_field, 
                    valueProviderCallback: (_) => {
                        Cal_Bandcoarse_ValueProvider(_);
                        return cal_bandcoarse_field.Value;
                    },
                    writeCallback: (_, __) => {
                        WriteRWSYNC();
                        Cal_Bandcoarse_Write(_, __);
                    },
                    
                    readCallback: (_, __) => Cal_Bandcoarse_Read(_, __),
                    name: "Bandcoarse")
            
            .WithValueField(15, 6, out cal_bandfine_field, 
                    valueProviderCallback: (_) => {
                        Cal_Bandfine_ValueProvider(_);
                        return cal_bandfine_field.Value;
                    },
                    writeCallback: (_, __) => {
                        WriteRWSYNC();
                        Cal_Bandfine_Write(_, __);
                    },
                    
                    readCallback: (_, __) => Cal_Bandfine_Read(_, __),
                    name: "Bandfine")
            .WithEnumField<DoubleWordRegister, CAL_CLKDIV>(21, 2, out cal_clkdiv_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(23, 2, out cal_sigmadelta_field, 
                    valueProviderCallback: (_) => {
                        Cal_Sigmadelta_ValueProvider(_);
                        return cal_sigmadelta_field.Value;
                    },
                    writeCallback: (_, __) => {
                        WriteRWSYNC();
                        Cal_Sigmadelta_Write(_, __);
                    },
                    
                    readCallback: (_, __) => Cal_Sigmadelta_Read(_, __),
                    name: "Sigmadelta")
            
            .WithValueField(25, 3, out cal_bias_field, 
                    valueProviderCallback: (_) => {
                        Cal_Bias_ValueProvider(_);
                        return cal_bias_field.Value;
                    },
                    writeCallback: (_, __) => {
                        WriteRWSYNC();
                        Cal_Bias_Write(_, __);
                    ...
                    readCallback: (_, __) => Cal_Bias_Read(_, __),
                    name: "Bias")
            
            .WithValueField(28, 4, out cal_tempco_field, 
                    valueProviderCallback: (_) => {
                        Cal_Tempco_ValueProvider(_);
                        return cal_tempco_field.Value;
                    },
                    writeCallback: (_, __) => {
                        WriteRWSYNC();
                        Cal_Tempco_Write(_, __);
                    },
                    
                    readCallback: (_, __) => Cal_Tempco_Read(_, __),
                    name: "Tempco")
        ...
        protected DoubleWordRegister GenerateFeatureRegister() => new DoubleWordRegister(this, 0x0)
            .WithFlag(0, out feature_forcemax_bit, 
                    valueProviderCallback: (_) => {
                        Feature_Forcemax_ValueProvider(_);
                        return feature_forcemax_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Feature_Forcemax_Write(_, __),
                    
                    readCallback: (_, __) => Feature_Forcemax_Read(_, __),
                    name: "Forcemax")
            
            .WithValueField(1, 3, out feature_bandcoarseul_field, 
                    valueProviderCallback: (_) => {
                        Feature_Bandcoarseul_ValueProvider(_);
                        return feature_bandcoarseul_field.Value;
                    },
                    
                    writeCallback: (_, __) => Feature_Bandcoarseul_Write(_, __),
                    
                    readCallback: (_, __) => Feature_Bandcoarseul_Read(_, __),
                    name: "Bandcoarseul")
            .WithReservedBits(4, 28)
        ...
        protected IValueRegisterField cal_bandcoarse_field;
        partial void Cal_Bandcoarse_Write(ulong a, ulong b);
        partial void Cal_Bandcoarse_Read(ulong a, ulong b);
        partial void Cal_Bandcoarse_ValueProvider(ulong a);
    
        protected IValueRegisterField cal_bandfine_field;
        partial void Cal_Bandfine_Write(ulong a, ulong b);
        partial void Cal_Bandfine_Read(ulong a, ulong b);
        partial void Cal_Bandfine_ValueProvider(ulong a);
        ...
        protected IValueRegisterField cal_sigmadelta_field;
        partial void Cal_Sigmadelta_Write(ulong a, ulong b);
        partial void Cal_Sigmadelta_Read(ulong a, ulong b);
        partial void Cal_Sigmadelta_ValueProvider(ulong a);
    
        protected IValueRegisterField cal_bias_field;
        partial void Cal_Bias_Write(ulong a, ulong b);
        partial void Cal_Bias_Read(ulong a, ulong b);
        partial void Cal_Bias_ValueProvider(ulong a);
    
        protected IValueRegisterField cal_tempco_field;
        partial void Cal_Tempco_Write(ulong a, ulong b);
        partial void Cal_Tempco_Read(ulong a, ulong b);
        partial void Cal_Tempco_ValueProvider(ulong a);
        ...
        protected IFlagRegisterField feature_forcemax_bit;
        partial void Feature_Forcemax_Write(bool a, bool b);
        partial void Feature_Forcemax_Read(bool a, bool b);
        partial void Feature_Forcemax_ValueProvider(bool a);
    
        protected IValueRegisterField feature_bandcoarseul_field;
        partial void Feature_Bandcoarseul_Write(ulong a, ulong b);
        partial void Feature_Bandcoarseul_Read(ulong a, ulong b);
        partial void Feature_Bandcoarseul_ValueProvider(ulong a);
