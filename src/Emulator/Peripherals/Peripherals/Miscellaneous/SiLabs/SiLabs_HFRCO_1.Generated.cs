...
/*  WARNING: Auto-Generated Peripheral  -  DO NOT EDIT
    HFRCO, Generated on : 2025-07-25 13:42:03.178993
    HFRCO, ID Version : 165adedf604742fda856a08648e115e5.1 */
    ...
    public partial class SiLabs_HFRCO_1 : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        private void WriteRWSYNC()
        {
            if(!Enabled)
            {
                ...
                this.Log(LogLevel.Warning, "Trying to write to a RWSYNC register while peripheral is disabled EN = {0}", Enabled);
            }
        }
