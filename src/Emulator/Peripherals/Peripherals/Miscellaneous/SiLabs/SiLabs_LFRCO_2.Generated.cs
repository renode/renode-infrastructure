...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    ...
    {
        public SiLabs_LFRCO_2(Machine machine) : base(machine)
        {
            SiLabs_LFRCO_2_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_LFRCO_2 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_LFRCO_2(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_LFRCO_2_Constructor();
