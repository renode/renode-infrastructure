...
{
    public partial class SiLabs_SYSCFG_3
    {
        public SiLabs_SYSCFG_3(Machine machine) : base(machine)
        {
            SiLabs_SYSCFG_3_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_SYSCFG_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_SYSCFG_3(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_SYSCFG_3_Constructor();
