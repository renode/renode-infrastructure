...
{
    public partial class SiLabs_CMU_3
    {
        public SiLabs_CMU_3(Machine machine) : base(machine)
        {
            SiLabs_CMU_3_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_CMU_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_CMU_3(Machine machine) : base(machine)
        {
            Define_Registers();
