...
{
    public partial class SiLabs_LFXO_1
    {
        public SiLabs_LFXO_1(Machine machine) : base(machine)
        {
            SiLabs_LFXO_1_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_LFXO_1 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_LFXO_1(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_LFXO_1_Constructor();
