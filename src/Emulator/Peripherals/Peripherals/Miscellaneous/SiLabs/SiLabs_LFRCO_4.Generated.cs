...
/*  WARNING: Auto-Generated Peripheral  -  DO NOT EDIT
    LFRCO, Generated on : 2025-05-08 15:30:06.480183
    LFRCO, ID Version : c5b974e8e30f414db1344f6c7175dc21.4 */
...
{
    public partial class SiLabs_LFRCO_4 : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        protected DoubleWordRegister GenerateIpversionRegister() => new DoubleWordRegister(this, 0x4)
        ...
        protected DoubleWordRegister GenerateHiprecisionRegister() => new DoubleWordRegister(this, 0x10E23045)
        ...
        // Trim - Offset : 0x38
        protected DoubleWordRegister GenerateTrimRegister() => new DoubleWordRegister(this, 0x52874820)
            ...
            .WithValueField(8, 7, out trim_trim_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(20, 3, out trim_plfrcobias_field, 
                    valueProviderCallback: (_) => {
                        Trim_Plfrcobias_ValueProvider(_);
                        return trim_plfrcobias_field.Value;
                    },
                    
                    writeCallback: (_, __) => Trim_Plfrcobias_Write(_, __),
                    
                    readCallback: (_, __) => Trim_Plfrcobias_Read(_, __),
                    name: "Plfrcobias")
            
            .WithValueField(23, 4, out trim_tempcomain_field, 
                    valueProviderCallback: (_) => {
                        Trim_Tempcomain_ValueProvider(_);
                        return trim_tempcomain_field.Value;
                    },
                    
                    writeCallback: (_, __) => Trim_Tempcomain_Write(_, __),
                    
                    readCallback: (_, __) => Trim_Tempcomain_Read(_, __),
                    name: "Tempcomain")
            
            .WithValueField(27, 2, out trim_roten_field, 
                    valueProviderCallback: (_) => {
        ...
        protected DoubleWordRegister GenerateTrimhiprecRegister() => new DoubleWordRegister(this, 0x1E606020)
            ...
            .WithValueField(8, 7, out trimhiprec_trimhiprec_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(23, 4, out trimhiprec_tempcomainhiprec_field, 
                    valueProviderCallback: (_) => {
                        Trimhiprec_Tempcomainhiprec_ValueProvider(_);
                        return trimhiprec_tempcomainhiprec_field.Value;
                    },
                    
                    writeCallback: (_, __) => Trimhiprec_Tempcomainhiprec_Write(_, __),
                    
                    readCallback: (_, __) => Trimhiprec_Tempcomainhiprec_Read(_, __),
                    name: "Tempcomainhiprec")
            
            .WithValueField(27, 2, out trimhiprec_rotenhiprec_field, 
                    valueProviderCallback: (_) => {
        ...
        protected IValueRegisterField trim_plfrcobias_field;
        partial void Trim_Plfrcobias_Write(ulong a, ulong b);
        partial void Trim_Plfrcobias_Read(ulong a, ulong b);
        partial void Trim_Plfrcobias_ValueProvider(ulong a);
    
        protected IValueRegisterField trim_tempcomain_field;
        partial void Trim_Tempcomain_Write(ulong a, ulong b);
        partial void Trim_Tempcomain_Read(ulong a, ulong b);
        partial void Trim_Tempcomain_ValueProvider(ulong a);
        ...
        protected IValueRegisterField trimhiprec_tempcomainhiprec_field;
        partial void Trimhiprec_Tempcomainhiprec_Write(ulong a, ulong b);
        partial void Trimhiprec_Tempcomainhiprec_Read(ulong a, ulong b);
        partial void Trimhiprec_Tempcomainhiprec_ValueProvider(ulong a);
