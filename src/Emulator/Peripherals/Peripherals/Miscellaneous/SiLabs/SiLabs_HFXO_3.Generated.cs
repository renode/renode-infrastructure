...
{
    public partial class SiLabs_HFXO_3
    {
        public SiLabs_HFXO_3(Machine machine) : base(machine)
        {
            SiLabs_HFXO_3_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_HFXO_3 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_HFXO_3(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_HFXO_3_Constructor();
