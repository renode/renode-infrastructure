...
/*  WARNING: Auto-Generated Peripheral  -  DO NOT EDIT
    EMU, Generated on : 2025-09-26 18:02:30.173058
    EMU, ID Version : ffc0fb7f840a4547a9111df0b917ddd3.9 */
...
{
    public partial class SiLabs_EMU_9 : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        private void Define_Registers()
        {
            var registersMap = new Dictionary<long, DoubleWordRegister>
            {
                ...
                {(long)Registers.Flreg, GenerateFlregRegister()},
                {(long)Registers.Flbod, GenerateFlbodRegister()},
                ...
                {(long)Registers.Rev_Ipversion, GenerateRev_ipversionRegister()},
                ...
                {(long)Registers.Isoovr, GenerateIsoovrRegister()},
                ...
                {(long)Registers.Periphstatus, GeneratePeriphstatusRegister()},
                ...
                {(long)Registers.Isbiasctrl_Isbiastempcompthr2, GenerateIsbiasctrl_isbiastempcompthr2Register()},
                {(long)Registers.Isbiasctrl_Vsbtempcompthr, GenerateIsbiasctrl_vsbtempcompthrRegister()},
                {(long)Registers.Isbiasctrl_Vsbtempcompthr2, GenerateIsbiasctrl_vsbtempcompthr2Register()},
                {(long)Registers.Isbiasctrl_Retregtempcompthr, GenerateIsbiasctrl_retregtempcompthrRegister()},
                {(long)Registers.Isbiasctrl_Retregtempcompthr2, GenerateIsbiasctrl_retregtempcompthr2Register()},
                {(long)Registers.Misc_Qspi, GenerateMisc_qspiRegister()},
                {(long)Registers.Rootctrl, GenerateRootctrlRegister()},
                {(long)Registers.Cfgdrpu_Cfgrpuratd0, GenerateCfgdrpu_cfgrpuratd0Register()},
                {(long)Registers.Cfgdrpu_Cfgrpuratd1, GenerateCfgdrpu_cfgrpuratd1Register()},
                {(long)Registers.Cfgdrpu_Cfgrpuratd2, GenerateCfgdrpu_cfgrpuratd2Register()},
                {(long)Registers.Cfgdrpu_Cfgrpuratd3, GenerateCfgdrpu_cfgrpuratd3Register()},
            };
        ...
        protected enum BOD3SENSETRIM_BOD3SENSEBLKDLY
        {
            DLY_800US = 0, // 800us
            DLY_960US = 1, // 960us
            DLY_1120US = 2, // 1120us
        ...
        protected enum RSTCTRL_FLBODRMODE
        {
            DISABLED = 0, // Reset request is blocked
            ENABLED = 1, // The entire device is reset
        }
        ...
        protected enum PERIPHSTATUS_PWRDWNSTATUS
        {
            IF_PD0D_I2C0 = 1, // 
            IF_PD1HOST_SE = 2, // 
            IF_PD1HOST_DMA = 4, // 
            IF_PD1HOST_CMUCAL = 8, // 
            IF_PD1HOST_SYSRTC = 16, // 
            IF_PD1HOST_TIMER = 32, // 
            IF_PD1HOST_I2C1 = 64, // 
            IF_PD1HOST_SLAXISYSMB = 128, // 
            IF_PD1HOST_HOSTFABRIC = 256, // 
            IF_PD1HOST_QSPI = 512, // 
            IF_PD1HOST_I2C2 = 1024, // 
            IF_PD1HOST_L2CACHE = 2048, // 
            IF_PD1HOST_L1CACHE = 4096, // 
            IF_PD1HOST_ICACHESHIM = 8192, // 
            IF_PD1HOST_EXTMEM = 16384, // 
            IF_PD1HOST_SWRSTDISMENT = 32768, // 
            IF_PD1LPW_ECA0 = 65536, // 
            IF_PD1LPW_ECA1 = 131072, // 
            IF_PD1LPW_RISCVSEQ = 262144, // 
            IF_PD1LPW_RISCVFASTSW = 524288, // 
            IF_PD1LPW_AHBRADIOTOAHB2X0 = 1048576, // 
            IF_PD1LPW_AHBRADIOTOAHB2X1 = 2097152, // 
            IF_PD1LPW_MBRIDGEHOST = 4194304, // 
            IF_PD1LPW_SBRIDGEHOST = 8388608, // 
            IF_PD1LPW_MBRIDGESYSMB = 16777216, // 
        }
        ...
        protected enum ISBIASCTRL_VSBTEMPCOMP_R4VSB
        {
            VSB100 = 0, // VSB100 is set
            VSB200 = 1, // VSB200 is set
            VSB300 = 2, // VSB300 is set
        ...
        protected enum ISBIASCTRL_VSBTEMPCOMP_R5VSB
        {
            VSB100 = 0, // VSB100 is set
            VSB200 = 1, // VSB200 is set
            VSB300 = 2, // VSB300 is set
        ...
        // Ldreg - Offset : 0x0
        protected DoubleWordRegister GenerateLdregRegister() => new DoubleWordRegister(this, 0x1)
            ...
            .WithFlag(29, out ldreg_ovrldregenibias_bit, 
                    valueProviderCallback: (_) => {
                        Ldreg_Ovrldregenibias_ValueProvider(_);
                        return ldreg_ovrldregenibias_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Ldreg_Ovrldregenibias_Write(_, __),
                    
                    readCallback: (_, __) => Ldreg_Ovrldregenibias_Read(_, __),
                    name: "Ovrldregenibias")
        ...
        protected DoubleWordRegister GenerateDvddlebodRegister() => new DoubleWordRegister(this, 0x106)
            ...
            .WithFlag(3, out dvddlebod_dvddlebodenbodhysn_bit, 
                    valueProviderCallback: (_) => {
                        Dvddlebod_Dvddlebodenbodhysn_ValueProvider(_);
                        return dvddlebod_dvddlebodenbodhysn_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Dvddlebod_Dvddlebodenbodhysn_Write(_, __),
                    
                    readCallback: (_, __) => Dvddlebod_Dvddlebodenbodhysn_Read(_, __),
                    name: "Dvddlebodenbodhysn")
        ...
        // Dvddbod - Offset : 0xC
        protected DoubleWordRegister GenerateDvddbodRegister() => new DoubleWordRegister(this, 0x26)
        ...
        protected DoubleWordRegister GenerateHdregRegister() => new DoubleWordRegister(this, 0x8)
            ...
            .WithFlag(8, out hdreg_hdregswhardswlowresmode_bit, 
                    valueProviderCallback: (_) => {
                        Hdreg_Hdregswhardswlowresmode_ValueProvider(_);
                        return hdreg_hdregswhardswlowresmode_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Hdreg_Hdregswhardswlowresmode_Write(_, __),
                    
                    readCallback: (_, __) => Hdreg_Hdregswhardswlowresmode_Read(_, __),
                    name: "Hdregswhardswlowresmode")
            .WithReservedBits(9, 3)
            .WithFlag(12, out hdreg_hdregswlowleakdis_bit, 
                    valueProviderCallback: (_) => {
                        Hdreg_Hdregswlowleakdis_ValueProvider(_);
                        return hdreg_hdregswlowleakdis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Hdreg_Hdregswlowleakdis_Write(_, __),
                    
                    readCallback: (_, __) => Hdreg_Hdregswlowleakdis_Read(_, __),
                    name: "Hdregswlowleakdis")
            .WithFlag(13, out hdreg_hdregenccdbiasdis_bit, 
                    valueProviderCallback: (_) => {
                        Hdreg_Hdregenccdbiasdis_ValueProvider(_);
                        return hdreg_hdregenccdbiasdis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Hdreg_Hdregenccdbiasdis_Write(_, __),
                    
                    readCallback: (_, __) => Hdreg_Hdregenccdbiasdis_Read(_, __),
                    name: "Hdregenccdbiasdis")
            ...
            .WithFlag(25, out hdreg_ovrhdregfrcregmode_bit, 
                    valueProviderCallback: (_) => {
                        Hdreg_Ovrhdregfrcregmode_ValueProvider(_);
                        return hdreg_ovrhdregfrcregmode_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Hdreg_Ovrhdregfrcregmode_Write(_, __),
                    
                    readCallback: (_, __) => Hdreg_Ovrhdregfrcregmode_Read(_, __),
                    name: "Ovrhdregfrcregmode")
            .WithFlag(26, out hdreg_ovrhdregccdbias_bit, 
                    valueProviderCallback: (_) => {
                        Hdreg_Ovrhdregccdbias_ValueProvider(_);
                        return hdreg_ovrhdregccdbias_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Hdreg_Ovrhdregccdbias_Write(_, __),
                    
                    readCallback: (_, __) => Hdreg_Ovrhdregccdbias_Read(_, __),
                    name: "Ovrhdregccdbias")
        ...
        protected DoubleWordRegister GenerateRetregRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithValueField(8, 6, out retreg_retregidactrim_field, 
                    valueProviderCallback: (_) => {
        ...
        protected DoubleWordRegister GenerateBod3sensetrimRegister() => new DoubleWordRegister(this, 0x4210)
            ...
            .WithEnumField<DoubleWordRegister, BOD3SENSETRIM_BOD3SENSEBLKDLY>(16, 2, out bod3sensetrim_bod3senseblkdly_field, 
                    valueProviderCallback: (_) => {
                        Bod3sensetrim_Bod3senseblkdly_ValueProvider(_);
                        return bod3sensetrim_bod3senseblkdly_field.Value;
                    },
                    
                    writeCallback: (_, __) => Bod3sensetrim_Bod3senseblkdly_Write(_, __),
                    
                    readCallback: (_, __) => Bod3sensetrim_Bod3senseblkdly_Read(_, __),
                    name: "Bod3senseblkdly")
            .WithReservedBits(18, 1)
            .WithFlag(19, out bod3sensetrim_bode3senseenhysn_bit, 
                    valueProviderCallback: (_) => {
                        Bod3sensetrim_Bode3senseenhysn_ValueProvider(_);
                        return bod3sensetrim_bode3senseenhysn_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Bod3sensetrim_Bode3senseenhysn_Write(_, __),
                    
                    readCallback: (_, __) => Bod3sensetrim_Bode3senseenhysn_Read(_, __),
                    name: "Bode3senseenhysn")
        ...
        protected DoubleWordRegister GenerateIsbiastrimRegister() => new DoubleWordRegister(this, 0x8F43A934)
            
            .WithValueField(0, 3, out isbiastrim_isbiastrim1p2_field, 
                    valueProviderCallback: (_) => {
                        Isbiastrim_Isbiastrim1p2_ValueProvider(_);
                        return isbiastrim_isbiastrim1p2_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiastrim_Isbiastrim1p2_Write(_, __),
                    
                    readCallback: (_, __) => Isbiastrim_Isbiastrim1p2_Read(_, __),
                    name: "Isbiastrim1p2")
            .WithReservedBits(3, 1)
            ...
            .WithValueField(25, 4, out isbiastrim_isbiastrim0p98_field, 
                    valueProviderCallback: (_) => {
                        Isbiastrim_Isbiastrim0p98_ValueProvider(_);
                        return isbiastrim_isbiastrim0p98_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiastrim_Isbiastrim0p98_Write(_, __),
                    
                    readCallback: (_, __) => Isbiastrim_Isbiastrim0p98_Read(_, __),
                    name: "Isbiastrim0p98")
            
            .WithValueField(29, 3, out isbiastrim_isbiastrim0p7_field, 
                    valueProviderCallback: (_) => {
                        Isbiastrim_Isbiastrim0p7_ValueProvider(_);
                        return isbiastrim_isbiastrim0p7_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiastrim_Isbiastrim0p7_Write(_, __),
                    
                    readCallback: (_, __) => Isbiastrim_Isbiastrim0p7_Read(_, __),
                    name: "Isbiastrim0p7")
            .WithReadCallback((_, __) => Isbiastrim_Read(_, __))
            .WithWriteCallback((_, __) => Isbiastrim_Write(_, __));
        
        // Isbiasvrefregtrim - Offset : 0x2C
        protected DoubleWordRegister GenerateIsbiasvrefregtrimRegister() => new DoubleWordRegister(this, 0x17406)
        ...
        protected DoubleWordRegister GenerateIsbiasvreflvbodtrimRegister() => new DoubleWordRegister(this, 0x17406)
        ...
        protected DoubleWordRegister GenerateAnastatusRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithReservedBits(5, 1)
            .WithFlag(6, out anastatus_flbodmaskoncfgchg_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Anastatus_Flbodmaskoncfgchg_ValueProvider(_);
                        return anastatus_flbodmaskoncfgchg_bit.Value;
                    },
                    
                    readCallback: (_, __) => Anastatus_Flbodmaskoncfgchg_Read(_, __),
                    name: "Flbodmaskoncfgchg")
            ...
            .WithFlag(18, out anastatus_decovmbod_bit, FieldMode.Read,
                    ...
                    name: "Decovmbod")
            .WithFlag(19, out anastatus_flregrdy_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Anastatus_Flregrdy_ValueProvider(_);
                        return anastatus_flregrdy_bit.Value;
                    },
                    
                    readCallback: (_, __) => Anastatus_Flregrdy_Read(_, __),
                    name: "Flregrdy")
        ...
        // Flreg - Offset : 0x40
        protected DoubleWordRegister GenerateFlregRegister() => new DoubleWordRegister(this, 0x30202)
            .WithFlag(0, out flreg_en_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_En_ValueProvider(_);
                        return flreg_en_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_En_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_En_Read(_, __),
                    name: "En")
            .WithFlag(1, out flreg_disclamp_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Disclamp_ValueProvider(_);
                        return flreg_disclamp_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Disclamp_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Disclamp_Read(_, __),
                    name: "Disclamp")
            .WithReservedBits(2, 1)
            .WithFlag(3, out flreg_enpulldn_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Enpulldn_ValueProvider(_);
                        return flreg_enpulldn_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Enpulldn_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Enpulldn_Read(_, __),
                    name: "Enpulldn")
            .WithFlag(4, out flreg_em2dis_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Em2dis_ValueProvider(_);
                        return flreg_em2dis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Em2dis_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Em2dis_Read(_, __),
                    name: "Em2dis")
            .WithReservedBits(5, 2)
            
            .WithValueField(7, 3, out flreg_vtrim_field, 
                    valueProviderCallback: (_) => {
                        Flreg_Vtrim_ValueProvider(_);
                        return flreg_vtrim_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Vtrim_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Vtrim_Read(_, __),
                    name: "Vtrim")
            
            .WithValueField(10, 3, out flreg_ilmt_field, 
                    valueProviderCallback: (_) => {
                        Flreg_Ilmt_ValueProvider(_);
                        return flreg_ilmt_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ilmt_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ilmt_Read(_, __),
                    name: "Ilmt")
            .WithReservedBits(13, 1)
            .WithEnumField<DoubleWordRegister, FLREG_SSRAMP>(14, 2, out flreg_ssramp_field, 
                    valueProviderCallback: (_) => {
                        Flreg_Ssramp_ValueProvider(_);
                        return flreg_ssramp_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ssramp_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ssramp_Read(_, __),
                    name: "Ssramp")
            
            .WithValueField(16, 2, out flreg_cz_field, 
                    valueProviderCallback: (_) => {
                        Flreg_Cz_ValueProvider(_);
                        return flreg_cz_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Cz_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Cz_Read(_, __),
                    name: "Cz")
            .WithReservedBits(18, 4)
            .WithFlag(22, out flreg_enreg1v2_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Enreg1v2_ValueProvider(_);
                        return flreg_enreg1v2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Enreg1v2_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Enreg1v2_Read(_, __),
                    name: "Enreg1v2")
            .WithReservedBits(23, 5)
            .WithFlag(28, out flreg_ovren_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Ovren_ValueProvider(_);
                        return flreg_ovren_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ovren_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ovren_Read(_, __),
                    name: "Ovren")
            .WithFlag(29, out flreg_ovrenbias_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Ovrenbias_ValueProvider(_);
                        return flreg_ovrenbias_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ovrenbias_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ovrenbias_Read(_, __),
                    name: "Ovrenbias")
            .WithFlag(30, out flreg_ovrenlp_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Ovrenlp_ValueProvider(_);
                        return flreg_ovrenlp_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ovrenlp_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ovrenlp_Read(_, __),
                    name: "Ovrenlp")
            .WithFlag(31, out flreg_ovroverrideen_bit, 
                    valueProviderCallback: (_) => {
                        Flreg_Ovroverrideen_ValueProvider(_);
                        return flreg_ovroverrideen_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flreg_Ovroverrideen_Write(_, __),
                    
                    readCallback: (_, __) => Flreg_Ovroverrideen_Read(_, __),
                    name: "Ovroverrideen")
            .WithReadCallback((_, __) => Flreg_Read(_, __))
            .WithWriteCallback((_, __) => Flreg_Write(_, __));
        
        // Flbod - Offset : 0x4C
        protected DoubleWordRegister GenerateFlbodRegister() => new DoubleWordRegister(this, 0x106)
            .WithFlag(0, out flbod_en_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_En_ValueProvider(_);
                        return flbod_en_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_En_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_En_Read(_, __),
                    name: "En")
            .WithFlag(1, out flbod_bodmask_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Bodmask_ValueProvider(_);
                        return flbod_bodmask_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Bodmask_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Bodmask_Read(_, __),
                    name: "Bodmask")
            .WithFlag(2, out flbod_em2dis_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Em2dis_ValueProvider(_);
                        return flbod_em2dis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Em2dis_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Em2dis_Read(_, __),
                    name: "Em2dis")
            .WithReservedBits(3, 1)
            
            .WithValueField(4, 5, out flbod_thres_field, 
                    valueProviderCallback: (_) => {
                        Flbod_Thres_ValueProvider(_);
                        return flbod_thres_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Thres_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Thres_Read(_, __),
                    name: "Thres")
            
            .WithValueField(9, 2, out flbod_hys_field, 
                    valueProviderCallback: (_) => {
                        Flbod_Hys_ValueProvider(_);
                        return flbod_hys_field.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Hys_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Hys_Read(_, __),
                    name: "Hys")
            .WithReservedBits(11, 5)
            .WithFlag(16, out flbod_forceflregrdy_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Forceflregrdy_ValueProvider(_);
                        return flbod_forceflregrdy_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Forceflregrdy_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Forceflregrdy_Read(_, __),
                    name: "Forceflregrdy")
            .WithFlag(17, out flbod_enreg1v2_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Enreg1v2_ValueProvider(_);
                        return flbod_enreg1v2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Enreg1v2_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Enreg1v2_Read(_, __),
                    name: "Enreg1v2")
            .WithReservedBits(18, 10)
            .WithFlag(28, out flbod_ovren_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Ovren_ValueProvider(_);
                        return flbod_ovren_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Ovren_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Ovren_Read(_, __),
                    name: "Ovren")
            .WithReservedBits(29, 2)
            .WithFlag(31, out flbod_ovroverrideen_bit, 
                    valueProviderCallback: (_) => {
                        Flbod_Ovroverrideen_ValueProvider(_);
                        return flbod_ovroverrideen_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Flbod_Ovroverrideen_Write(_, __),
                    
                    readCallback: (_, __) => Flbod_Ovroverrideen_Read(_, __),
                    name: "Ovroverrideen")
            .WithReadCallback((_, __) => Flbod_Read(_, __))
            .WithWriteCallback((_, __) => Flbod_Write(_, __));
        
        // Pd1paretctrl - Offset : 0x50
        ...
        // Rev_Ipversion - Offset : 0x5C
        protected DoubleWordRegister GenerateRev_ipversionRegister() => new DoubleWordRegister(this, 0x9)
            
            .WithValueField(0, 32, out rev_ipversion_ipversion_field, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Rev_Ipversion_Ipversion_ValueProvider(_);
                        return rev_ipversion_ipversion_field.Value;
                    },
                    
                    readCallback: (_, __) => Rev_Ipversion_Ipversion_Read(_, __),
                    name: "Ipversion")
            .WithReadCallback((_, __) => Rev_Ipversion_Read(_, __))
            .WithWriteCallback((_, __) => Rev_Ipversion_Write(_, __));
        ...
        protected DoubleWordRegister GenerateCtrlRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithFlag(23, out ctrl_em2emulen_bit, 
                    valueProviderCallback: (_) => {
                        Ctrl_Em2emulen_ValueProvider(_);
                        return ctrl_em2emulen_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Ctrl_Em2emulen_Write(_, __),
                    
                    readCallback: (_, __) => Ctrl_Em2emulen_Read(_, __),
                    name: "Em2emulen")
        ...
        protected DoubleWordRegister GenerateTestctrlRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithFlag(22, out testctrl_padfeedbackdis_bit, 
                    valueProviderCallback: (_) => {
                        Testctrl_Padfeedbackdis_ValueProvider(_);
                        return testctrl_padfeedbackdis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Testctrl_Padfeedbackdis_Write(_, __),
                    
                    readCallback: (_, __) => Testctrl_Padfeedbackdis_Read(_, __),
                    name: "Padfeedbackdis")
            .WithReservedBits(23, 1)
            
            .WithValueField(24, 4, out testctrl_prslvcfg_field, 
                    valueProviderCallback: (_) => {
            ...
            .WithValueField(28, 4, out testctrl_prshvcfg_field, 
                    valueProviderCallback: (_) => {
        ...
        protected DoubleWordRegister GenerateRstctrlRegister() => new DoubleWordRegister(this, 0x60407)
            ...
            .WithEnumField<DoubleWordRegister, RSTCTRL_DECBODRMODE>(10, 1, out rstctrl_decbodrmode_bit, 
                    ...
                    name: "Decbodrmode")
            .WithEnumField<DoubleWordRegister, RSTCTRL_FLBODRMODE>(11, 1, out rstctrl_flbodrmode_bit, 
                    valueProviderCallback: (_) => {
                        Rstctrl_Flbodrmode_ValueProvider(_);
                        return rstctrl_flbodrmode_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Rstctrl_Flbodrmode_Write(_, __),
                    
                    readCallback: (_, __) => Rstctrl_Flbodrmode_Read(_, __),
                    name: "Flbodrmode")
        ...
        protected DoubleWordRegister GenerateRstcauseRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithFlag(12, out rstcause_iovdd1bod_bit, FieldMode.Read,
                    ...
                    name: "Iovdd1bod")
            .WithFlag(13, out rstcause_flbod_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Rstcause_Flbod_ValueProvider(_);
                        return rstcause_flbod_bit.Value;
                    },
                    
                    readCallback: (_, __) => Rstcause_Flbod_Read(_, __),
                    name: "Flbod")
            .WithFlag(14, out rstcause_setamper_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Rstcause_Setamper_ValueProvider(_);
                        return rstcause_setamper_bit.Value;
                    },
                    
                    readCallback: (_, __) => Rstcause_Setamper_Read(_, __),
                    name: "Setamper")
            .WithFlag(15, out rstcause_m0sysreq_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
                    ...
                    name: "M0sysreq")
            .WithFlag(16, out rstcause_m0lockup_bit, FieldMode.Read,
                    valueProviderCallback: (_) => {
        ...
        // Isoovr - Offset : 0xA0
        protected DoubleWordRegister GenerateIsoovrRegister() => new DoubleWordRegister(this, 0x0)
            
            .WithValueField(0, 2, out isoovr_rfdigiso_field, 
                    valueProviderCallback: (_) => {
                        Isoovr_Rfdigiso_ValueProvider(_);
                        return isoovr_rfdigiso_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isoovr_Rfdigiso_Write(_, __),
                    
                    readCallback: (_, __) => Isoovr_Rfdigiso_Read(_, __),
                    name: "Rfdigiso")
            .WithReservedBits(2, 30)
            .WithReadCallback((_, __) => Isoovr_Read(_, __))
            .WithWriteCallback((_, __) => Isoovr_Write(_, __));
        ...
        // Periphstatus - Offset : 0xBC
        protected DoubleWordRegister GeneratePeriphstatusRegister() => new DoubleWordRegister(this, 0x0)
            .WithEnumField<DoubleWordRegister, PERIPHSTATUS_PWRDWNSTATUS>(0, 25, out periphstatus_pwrdwnstatus_field, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Periphstatus_Pwrdwnstatus_ValueProvider(_);
                        return periphstatus_pwrdwnstatus_field.Value;
                    },
                    
                    readCallback: (_, __) => Periphstatus_Pwrdwnstatus_Read(_, __),
                    name: "Pwrdwnstatus")
            .WithReservedBits(25, 7)
            .WithReadCallback((_, __) => Periphstatus_Read(_, __))
            .WithWriteCallback((_, __) => Periphstatus_Write(_, __));
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiasperiodRegister() => new DoubleWordRegister(this, 0x1030003)
            ...
            .WithEnumField<DoubleWordRegister, ISBIASCTRL_ISBIASPERIOD_CALPERIOD>(16, 3, out isbiasctrl_isbiasperiod_calperiod_field, 
                    ...
                    name: "Calperiod")
            .WithReservedBits(19, 5)
            .WithFlag(24, out isbiasctrl_isbiasperiod_em2periodx4_bit, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiasperiod_Em2periodx4_ValueProvider(_);
                        return isbiasctrl_isbiasperiod_em2periodx4_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiasperiod_Em2periodx4_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiasperiod_Em2periodx4_Read(_, __),
                    name: "Em2periodx4")
            .WithReservedBits(25, 7)
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiastempcomprateRegister() => new DoubleWordRegister(this, 0x666431)
            ...
            .WithValueField(16, 3, out isbiasctrl_isbiastempcomprate_r4refreshrate_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiastempcomprate_R4refreshrate_ValueProvider(_);
                        return isbiasctrl_isbiastempcomprate_r4refreshrate_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiastempcomprate_R4refreshrate_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiastempcomprate_R4refreshrate_Read(_, __),
                    name: "R4refreshrate")
            .WithReservedBits(19, 1)
            
            .WithValueField(20, 3, out isbiasctrl_isbiastempcomprate_r5refreshrate_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiastempcomprate_R5refreshrate_ValueProvider(_);
                        return isbiasctrl_isbiastempcomprate_r5refreshrate_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiastempcomprate_R5refreshrate_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiastempcomprate_R5refreshrate_Read(_, __),
                    name: "R5refreshrate")
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiaspfmrefreshcfgRegister() => new DoubleWordRegister(this, 0x60020C)
            ...
            .WithEnumField<DoubleWordRegister, ISBIASCTRL_ISBIASPFMREFRESHCFG_S2PREPDIVRATIO>(8, 3, out isbiasctrl_isbiaspfmrefreshcfg_s2prepdivratio_field, 
                    ...
                    name: "S2prepdivratio")
            .WithReservedBits(11, 1)
            .WithFlag(12, out isbiasctrl_isbiaspfmrefreshcfg_s2roomtempdiv2_bit, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_ValueProvider(_);
                        return isbiasctrl_isbiaspfmrefreshcfg_s2roomtempdiv2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_Read(_, __),
                    name: "S2roomtempdiv2")
            .WithFlag(13, out isbiasctrl_isbiaspfmrefreshcfg_s2fastrfrshem2entryctrl_bit, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_ValueProvider(_);
                        return isbiasctrl_isbiaspfmrefreshcfg_s2fastrfrshem2entryctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_Read(_, __),
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiasrefreshcfgRegister() => new DoubleWordRegister(this, 0x20004A9C)
            ...
            .WithValueField(26, 6, out isbiasctrl_isbiasrefreshcfg_s1temprangecont_field, 
                    valueProviderCallback: (_) => {
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiastempconstRegister() => new DoubleWordRegister(this, 0x7C319)
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_isbiasstatusRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithValueField(17, 3, out isbiasctrl_isbiasstatus_retregtemprange_field, FieldMode.Read,
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiasstatus_Retregtemprange_ValueProvider(_);
                        return isbiasctrl_isbiasstatus_retregtemprange_field.Value;
                    },
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiasstatus_Retregtemprange_Read(_, __),
                    name: "Retregtemprange")
            ...
            .WithValueField(24, 3, out isbiasctrl_isbiasstatus_vsbtemprange_field, FieldMode.Read,
                    valueProviderCallback: (_) => {
        ...
        protected DoubleWordRegister GenerateIsbiasctrl_vsbtempcompRegister() => new DoubleWordRegister(this, 0x51)
            ...
            .WithEnumField<DoubleWordRegister, ISBIASCTRL_VSBTEMPCOMP_R3VSB>(8, 2, out isbiasctrl_vsbtempcomp_r3vsb_field, 
                    ...
                    name: "R3vsb")
            .WithEnumField<DoubleWordRegister, ISBIASCTRL_VSBTEMPCOMP_R4VSB>(10, 2, out isbiasctrl_vsbtempcomp_r4vsb_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Vsbtempcomp_R4vsb_ValueProvider(_);
                        return isbiasctrl_vsbtempcomp_r4vsb_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Vsbtempcomp_R4vsb_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Vsbtempcomp_R4vsb_Read(_, __),
                    name: "R4vsb")
            .WithEnumField<DoubleWordRegister, ISBIASCTRL_VSBTEMPCOMP_R5VSB>(12, 2, out isbiasctrl_vsbtempcomp_r5vsb_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Vsbtempcomp_R5vsb_ValueProvider(_);
                        return isbiasctrl_vsbtempcomp_r5vsb_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Vsbtempcomp_R5vsb_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Vsbtempcomp_R5vsb_Read(_, __),
                    name: "R5vsb")
            .WithReservedBits(14, 17)
        ...
        // Isbiasctrl_Retregtempcomp - Offset : 0xEC
        protected DoubleWordRegister GenerateIsbiasctrl_retregtempcompRegister() => new DoubleWordRegister(this, 0x0)
            ...
            .WithValueField(16, 4, out isbiasctrl_retregtempcomp_r4retreghstrim_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcomp_R4retreghstrim_ValueProvider(_);
                        return isbiasctrl_retregtempcomp_r4retreghstrim_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcomp_R4retreghstrim_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcomp_R4retreghstrim_Read(_, __),
                    name: "R4retreghstrim")
            
            .WithValueField(20, 4, out isbiasctrl_retregtempcomp_r5retreghstrim_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcomp_R5retreghstrim_ValueProvider(_);
                        return isbiasctrl_retregtempcomp_r5retreghstrim_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcomp_R5retreghstrim_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcomp_R5retreghstrim_Read(_, __),
                    name: "R5retreghstrim")
            .WithReservedBits(24, 8)
            .WithReadCallback((_, __) => Isbiasctrl_Retregtempcomp_Read(_, __))
            .WithWriteCallback((_, __) => Isbiasctrl_Retregtempcomp_Write(_, __));
        
        // Isbiasctrl_Isbiastempcompthr - Offset : 0xF8
        protected DoubleWordRegister GenerateIsbiasctrl_isbiastempcompthrRegister() => new DoubleWordRegister(this, 0x17559948)
        ...
        // Isbiasctrl_Isbiastempcompthr2 - Offset : 0xFC
        protected DoubleWordRegister GenerateIsbiasctrl_isbiastempcompthr2Register() => new DoubleWordRegister(this, 0x745A3)
            
            .WithValueField(0, 9, out isbiasctrl_isbiastempcompthr2_r4tempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiastempcompthr2_R4tempthr_ValueProvider(_);
                        return isbiasctrl_isbiastempcompthr2_r4tempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiastempcompthr2_R4tempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiastempcompthr2_R4tempthr_Read(_, __),
                    name: "R4tempthr")
            .WithReservedBits(9, 1)
            
            .WithValueField(10, 9, out isbiasctrl_isbiastempcompthr2_r5tempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Isbiastempcompthr2_R5tempthr_ValueProvider(_);
                        return isbiasctrl_isbiastempcompthr2_r5tempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Isbiastempcompthr2_R5tempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Isbiastempcompthr2_R5tempthr_Read(_, __),
                    name: "R5tempthr")
            .WithReservedBits(19, 13)
            .WithReadCallback((_, __) => Isbiasctrl_Isbiastempcompthr2_Read(_, __))
            .WithWriteCallback((_, __) => Isbiasctrl_Isbiastempcompthr2_Write(_, __));
        
        // Isbiasctrl_Vsbtempcompthr - Offset : 0x100
        protected DoubleWordRegister GenerateIsbiasctrl_vsbtempcompthrRegister() => new DoubleWordRegister(this, 0x17A5491B)
        ...
        // Isbiasctrl_Vsbtempcompthr2 - Offset : 0x108
        protected DoubleWordRegister GenerateIsbiasctrl_vsbtempcompthr2Register() => new DoubleWordRegister(this, 0x74DA6)
            
            .WithValueField(0, 9, out isbiasctrl_vsbtempcompthr2_r4vsbtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_ValueProvider(_);
                        return isbiasctrl_vsbtempcompthr2_r4vsbtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_Read(_, __),
                    name: "R4vsbtempthr")
            .WithReservedBits(9, 1)
            
            .WithValueField(10, 9, out isbiasctrl_vsbtempcompthr2_r5vsbtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_ValueProvider(_);
                        return isbiasctrl_vsbtempcompthr2_r5vsbtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_Read(_, __),
                    name: "R5vsbtempthr")
            .WithReservedBits(19, 13)
            .WithReadCallback((_, __) => Isbiasctrl_Vsbtempcompthr2_Read(_, __))
            .WithWriteCallback((_, __) => Isbiasctrl_Vsbtempcompthr2_Write(_, __));
        
        // Isbiasctrl_Retregtempcompthr - Offset : 0x10C
        protected DoubleWordRegister GenerateIsbiasctrl_retregtempcompthrRegister() => new DoubleWordRegister(this, 0x17A5491B)
            
            .WithValueField(0, 9, out isbiasctrl_retregtempcompthr_r1retregtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcompthr_R1retregtempthr_ValueProvider(_);
                        return isbiasctrl_retregtempcompthr_r1retregtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R1retregtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R1retregtempthr_Read(_, __),
                    name: "R1retregtempthr")
            .WithReservedBits(9, 1)
            
            .WithValueField(10, 9, out isbiasctrl_retregtempcompthr_r2retregtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcompthr_R2retregtempthr_ValueProvider(_);
                        return isbiasctrl_retregtempcompthr_r2retregtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R2retregtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R2retregtempthr_Read(_, __),
                    name: "R2retregtempthr")
            .WithReservedBits(19, 1)
            
            .WithValueField(20, 9, out isbiasctrl_retregtempcompthr_r3retregtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcompthr_R3retregtempthr_ValueProvider(_);
                        return isbiasctrl_retregtempcompthr_r3retregtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R3retregtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcompthr_R3retregtempthr_Read(_, __),
                    name: "R3retregtempthr")
            .WithReservedBits(29, 3)
            .WithReadCallback((_, __) => Isbiasctrl_Retregtempcompthr_Read(_, __))
            .WithWriteCallback((_, __) => Isbiasctrl_Retregtempcompthr_Write(_, __));
        
        // Isbiasctrl_Retregtempcompthr2 - Offset : 0x110
        protected DoubleWordRegister GenerateIsbiasctrl_retregtempcompthr2Register() => new DoubleWordRegister(this, 0x74DA6)
            
            .WithValueField(0, 9, out isbiasctrl_retregtempcompthr2_r4retregtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcompthr2_R4retregtempthr_ValueProvider(_);
                        return isbiasctrl_retregtempcompthr2_r4retregtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcompthr2_R4retregtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcompthr2_R4retregtempthr_Read(_, __),
                    name: "R4retregtempthr")
            .WithReservedBits(9, 1)
            
            .WithValueField(10, 9, out isbiasctrl_retregtempcompthr2_r5retregtempthr_field, 
                    valueProviderCallback: (_) => {
                        Isbiasctrl_Retregtempcompthr2_R5retregtempthr_ValueProvider(_);
                        return isbiasctrl_retregtempcompthr2_r5retregtempthr_field.Value;
                    },
                    
                    writeCallback: (_, __) => Isbiasctrl_Retregtempcompthr2_R5retregtempthr_Write(_, __),
                    
                    readCallback: (_, __) => Isbiasctrl_Retregtempcompthr2_R5retregtempthr_Read(_, __),
                    name: "R5retregtempthr")
            .WithReservedBits(19, 13)
            .WithReadCallback((_, __) => Isbiasctrl_Retregtempcompthr2_Read(_, __))
            .WithWriteCallback((_, __) => Isbiasctrl_Retregtempcompthr2_Write(_, __));
        
        // Misc_Qspi - Offset : 0x130
        protected DoubleWordRegister GenerateMisc_qspiRegister() => new DoubleWordRegister(this, 0x0)
            
            .WithValueField(0, 3, out misc_qspi_qspicoderegionbankswap_field, 
                    valueProviderCallback: (_) => {
                        Misc_Qspi_Qspicoderegionbankswap_ValueProvider(_);
                        return misc_qspi_qspicoderegionbankswap_field.Value;
                    },
                    
                    writeCallback: (_, __) => Misc_Qspi_Qspicoderegionbankswap_Write(_, __),
                    
                    readCallback: (_, __) => Misc_Qspi_Qspicoderegionbankswap_Read(_, __),
                    name: "Qspicoderegionbankswap")
            .WithReservedBits(3, 29)
            .WithReadCallback((_, __) => Misc_Qspi_Read(_, __))
            .WithWriteCallback((_, __) => Misc_Qspi_Write(_, __));
        ...
        protected DoubleWordRegister GenerateRootctrlRegister() => new DoubleWordRegister(this, 0x0)
            .WithFlag(0, out rootctrl_vscalelock_bit, 
                    ...
                    name: "Vscalelock")
            .WithFlag(1, out rootctrl_em2dis_bit, 
                    valueProviderCallback: (_) => {
                        Rootctrl_Em2dis_ValueProvider(_);
                        return rootctrl_em2dis_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Rootctrl_Em2dis_Write(_, __),
                    
                    readCallback: (_, __) => Rootctrl_Em2dis_Read(_, __),
                    name: "Em2dis")
        ...
        // Cfgdrpu_Cfgrpuratd0 - Offset : 0x18C
        protected DoubleWordRegister GenerateCfgdrpu_cfgrpuratd0Register() => new DoubleWordRegister(this, 0x0)
            .WithFlag(0, out cfgdrpu_cfgrpuratd0_ratdldreg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdldreg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdldreg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdldreg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdldreg_Read(_, __),
                    name: "Ratdldreg")
            .WithFlag(1, out cfgdrpu_cfgrpuratd0_ratddvddlebod_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratddvddlebod_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_Read(_, __),
                    name: "Ratddvddlebod")
            .WithFlag(2, out cfgdrpu_cfgrpuratd0_ratdvlmthv_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdvlmthv_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_Read(_, __),
                    name: "Ratdvlmthv")
            .WithFlag(3, out cfgdrpu_cfgrpuratd0_ratddvddbod_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratddvddbod_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratddvddbod_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddvddbod_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddvddbod_Read(_, __),
                    name: "Ratddvddbod")
            .WithFlag(4, out cfgdrpu_cfgrpuratd0_ratddecbod_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratddecbod_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratddecbod_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddecbod_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratddecbod_Read(_, __),
                    name: "Ratddecbod")
            .WithFlag(5, out cfgdrpu_cfgrpuratd0_ratdhdreg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdhdreg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdhdreg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdhdreg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdhdreg_Read(_, __),
                    name: "Ratdhdreg")
            .WithFlag(6, out cfgdrpu_cfgrpuratd0_ratdretreg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdretreg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdretreg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdretreg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdretreg_Read(_, __),
                    name: "Ratdretreg")
            .WithFlag(7, out cfgdrpu_cfgrpuratd0_ratdbod3sensetrim_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdbod3sensetrim_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_Read(_, __),
                    name: "Ratdbod3sensetrim")
            .WithFlag(8, out cfgdrpu_cfgrpuratd0_ratdbod3sense_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdbod3sense_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_Read(_, __),
                    name: "Ratdbod3sense")
            .WithFlag(9, out cfgdrpu_cfgrpuratd0_ratdisbias_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdisbias_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdisbias_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbias_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbias_Read(_, __),
                    name: "Ratdisbias")
            .WithFlag(10, out cfgdrpu_cfgrpuratd0_ratdisbiastrim_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdisbiastrim_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_Read(_, __),
                    name: "Ratdisbiastrim")
            .WithFlag(11, out cfgdrpu_cfgrpuratd0_ratdisbiasvrefregtrim_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdisbiasvrefregtrim_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_Read(_, __),
                    name: "Ratdisbiasvrefregtrim")
            .WithFlag(12, out cfgdrpu_cfgrpuratd0_ratdisbiasvreflvbodtrim_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdisbiasvreflvbodtrim_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_Read(_, __),
                    name: "Ratdisbiasvreflvbodtrim")
            .WithReservedBits(13, 1)
            .WithFlag(14, out cfgdrpu_cfgrpuratd0_ratdpfmbyp_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdpfmbyp_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_Read(_, __),
                    name: "Ratdpfmbyp")
            .WithFlag(15, out cfgdrpu_cfgrpuratd0_ratdpfmbypctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdpfmbypctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_Read(_, __),
                    name: "Ratdpfmbypctrl")
            .WithFlag(16, out cfgdrpu_cfgrpuratd0_ratdflreg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdflreg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdflreg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdflreg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdflreg_Read(_, __),
                    name: "Ratdflreg")
            .WithReservedBits(17, 2)
            .WithFlag(19, out cfgdrpu_cfgrpuratd0_ratdflbod_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdflbod_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdflbod_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdflbod_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdflbod_Read(_, __),
                    name: "Ratdflbod")
            .WithFlag(20, out cfgdrpu_cfgrpuratd0_ratdpd1paretctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdpd1paretctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_Read(_, __),
                    name: "Ratdpd1paretctrl")
            .WithFlag(21, out cfgdrpu_cfgrpuratd0_ratdpd0pwrctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdpd0pwrctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_Read(_, __),
                    name: "Ratdpd0pwrctrl")
            .WithFlag(22, out cfgdrpu_cfgrpuratd0_ratdpd0pwrem2ctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdpd0pwrem2ctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_Read(_, __),
                    name: "Ratdpd0pwrem2ctrl")
            .WithReservedBits(23, 1)
            .WithFlag(24, out cfgdrpu_cfgrpuratd0_ratdlock_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdlock_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdlock_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdlock_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdlock_Read(_, __),
                    name: "Ratdlock")
            .WithFlag(25, out cfgdrpu_cfgrpuratd0_ratdif_bit, 
                    valueProviderCallback: (_) => {
                    ...
                    name: "Ratdif")
            .WithFlag(26, out cfgdrpu_cfgrpuratd0_ratdien_bit, 
                    valueProviderCallback: (_) => {
                    ...
                    name: "Ratdien")
            .WithFlag(27, out cfgdrpu_cfgrpuratd0_ratdem4ctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdem4ctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_Read(_, __),
                    name: "Ratdem4ctrl")
            .WithFlag(28, out cfgdrpu_cfgrpuratd0_ratdcmd_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdcmd_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdcmd_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdcmd_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdcmd_Read(_, __),
                    name: "Ratdcmd")
            .WithFlag(29, out cfgdrpu_cfgrpuratd0_ratdctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdctrl_Read(_, __),
                    name: "Ratdctrl")
            .WithFlag(30, out cfgdrpu_cfgrpuratd0_ratdtemplimits_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd0_ratdtemplimits_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_Read(_, __),
                    name: "Ratdtemplimits")
            .WithReservedBits(31, 1)
            .WithReadCallback((_, __) => Cfgdrpu_Cfgrpuratd0_Read(_, __))
            .WithWriteCallback((_, __) => Cfgdrpu_Cfgrpuratd0_Write(_, __));
        
        // Cfgdrpu_Cfgrpuratd1 - Offset : 0x190
        protected DoubleWordRegister GenerateCfgdrpu_cfgrpuratd1Register() => new DoubleWordRegister(this, 0x0)
            .WithFlag(0, out cfgdrpu_cfgrpuratd1_ratdtemplimitsse_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdtemplimitsse_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_Read(_, __),
                    name: "Ratdtemplimitsse")
            .WithReservedBits(1, 2)
            .WithFlag(3, out cfgdrpu_cfgrpuratd1_ratdtestctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdtestctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_Read(_, __),
                    name: "Ratdtestctrl")
            .WithFlag(4, out cfgdrpu_cfgrpuratd1_ratdrmuctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdrmuctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_Read(_, __),
                    name: "Ratdrmuctrl")
            .WithReservedBits(5, 3)
            .WithFlag(8, out cfgdrpu_cfgrpuratd1_ratdisoovr_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisoovr_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisoovr_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisoovr_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisoovr_Read(_, __),
                    name: "Ratdisoovr")
            .WithReservedBits(9, 3)
            .WithFlag(12, out cfgdrpu_cfgrpuratd1_ratddelaycfg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratddelaycfg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_Read(_, __),
                    name: "Ratddelaycfg")
            .WithFlag(13, out cfgdrpu_cfgrpuratd1_ratdtestlock_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdtestlock_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdtestlock_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtestlock_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdtestlock_Read(_, __),
                    name: "Ratdtestlock")
            .WithFlag(14, out cfgdrpu_cfgrpuratd1_ratdauxctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdauxctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_Read(_, __),
                    name: "Ratdauxctrl")
            .WithReservedBits(15, 1)
            .WithFlag(16, out cfgdrpu_cfgrpuratd1_ratdisbiasconf_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiasconf_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_Read(_, __),
                    name: "Ratdisbiasconf")
            .WithFlag(17, out cfgdrpu_cfgrpuratd1_ratdisbiascalovr_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiascalovr_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_Read(_, __),
                    name: "Ratdisbiascalovr")
            .WithFlag(18, out cfgdrpu_cfgrpuratd1_ratdisbiasperiod_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiasperiod_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_Read(_, __),
                    name: "Ratdisbiasperiod")
            .WithFlag(19, out cfgdrpu_cfgrpuratd1_ratdisbiastempcomprate_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiastempcomprate_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_Read(_, __),
                    name: "Ratdisbiastempcomprate")
            .WithReservedBits(20, 2)
            .WithFlag(22, out cfgdrpu_cfgrpuratd1_ratdisbiaspfmrefreshcfg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiaspfmrefreshcfg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_Read(_, __),
                    name: "Ratdisbiaspfmrefreshcfg")
            .WithFlag(23, out cfgdrpu_cfgrpuratd1_ratdisbiasrefreshcfg_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiasrefreshcfg_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_Read(_, __),
                    name: "Ratdisbiasrefreshcfg")
            .WithFlag(24, out cfgdrpu_cfgrpuratd1_ratdisbiastempconst_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiastempconst_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_Read(_, __),
                    name: "Ratdisbiastempconst")
            .WithReservedBits(25, 1)
            .WithFlag(26, out cfgdrpu_cfgrpuratd1_ratdvsbtempcomp_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdvsbtempcomp_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_Read(_, __),
                    name: "Ratdvsbtempcomp")
            .WithFlag(27, out cfgdrpu_cfgrpuratd1_ratdretregtempcomp_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdretregtempcomp_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_Read(_, __),
                    name: "Ratdretregtempcomp")
            .WithReservedBits(28, 2)
            .WithFlag(30, out cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_Read(_, __),
                    name: "Ratdisbiastempcompthr")
            .WithFlag(31, out cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr2_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_Read(_, __),
                    name: "Ratdisbiastempcompthr2")
            .WithReadCallback((_, __) => Cfgdrpu_Cfgrpuratd1_Read(_, __))
            .WithWriteCallback((_, __) => Cfgdrpu_Cfgrpuratd1_Write(_, __));
        
        // Cfgdrpu_Cfgrpuratd2 - Offset : 0x194
        protected DoubleWordRegister GenerateCfgdrpu_cfgrpuratd2Register() => new DoubleWordRegister(this, 0x0)
            .WithFlag(0, out cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_Read(_, __),
                    name: "Ratdvsbtempcompthr")
            .WithReservedBits(1, 1)
            .WithFlag(2, out cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr2_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_Read(_, __),
                    name: "Ratdvsbtempcompthr2")
            .WithFlag(3, out cfgdrpu_cfgrpuratd2_ratdretregtempcompthr_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd2_ratdretregtempcompthr_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_Read(_, __),
                    name: "Ratdretregtempcompthr")
            .WithFlag(4, out cfgdrpu_cfgrpuratd2_ratdretregtempcompthr2_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd2_ratdretregtempcompthr2_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_Read(_, __),
                    name: "Ratdretregtempcompthr2")
            .WithReservedBits(5, 7)
            .WithFlag(12, out cfgdrpu_cfgrpuratd2_ratdqspi_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd2_Ratdqspi_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd2_ratdqspi_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdqspi_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd2_Ratdqspi_Read(_, __),
                    name: "Ratdqspi")
            .WithReservedBits(13, 19)
            .WithReadCallback((_, __) => Cfgdrpu_Cfgrpuratd2_Read(_, __))
            .WithWriteCallback((_, __) => Cfgdrpu_Cfgrpuratd2_Write(_, __));
        
        // Cfgdrpu_Cfgrpuratd3 - Offset : 0x198
        protected DoubleWordRegister GenerateCfgdrpu_cfgrpuratd3Register() => new DoubleWordRegister(this, 0x0)
            .WithReservedBits(0, 2)
            .WithFlag(2, out cfgdrpu_cfgrpuratd3_ratdrootctrl_bit, 
                    valueProviderCallback: (_) => {
                        Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_ValueProvider(_);
                        return cfgdrpu_cfgrpuratd3_ratdrootctrl_bit.Value;
                    },
                    
                    writeCallback: (_, __) => Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_Write(_, __),
                    
                    readCallback: (_, __) => Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_Read(_, __),
                    name: "Ratdrootctrl")
            .WithReservedBits(3, 29)
            .WithReadCallback((_, __) => Cfgdrpu_Cfgrpuratd3_Read(_, __))
            .WithWriteCallback((_, __) => Cfgdrpu_Cfgrpuratd3_Write(_, __));
        ...
        protected IFlagRegisterField ldreg_ovrldregenibias_bit;
        partial void Ldreg_Ovrldregenibias_Write(bool a, bool b);
        partial void Ldreg_Ovrldregenibias_Read(bool a, bool b);
        partial void Ldreg_Ovrldregenibias_ValueProvider(bool a);
        ...
        protected IFlagRegisterField dvddlebod_dvddlebodenbodhysn_bit;
        partial void Dvddlebod_Dvddlebodenbodhysn_Write(bool a, bool b);
        partial void Dvddlebod_Dvddlebodenbodhysn_Read(bool a, bool b);
        partial void Dvddlebod_Dvddlebodenbodhysn_ValueProvider(bool a);
        ...
        protected IFlagRegisterField hdreg_hdregswhardswlowresmode_bit;
        partial void Hdreg_Hdregswhardswlowresmode_Write(bool a, bool b);
        partial void Hdreg_Hdregswhardswlowresmode_Read(bool a, bool b);
        partial void Hdreg_Hdregswhardswlowresmode_ValueProvider(bool a);
    
        protected IFlagRegisterField hdreg_hdregswlowleakdis_bit;
        partial void Hdreg_Hdregswlowleakdis_Write(bool a, bool b);
        partial void Hdreg_Hdregswlowleakdis_Read(bool a, bool b);
        partial void Hdreg_Hdregswlowleakdis_ValueProvider(bool a);
    
        protected IFlagRegisterField hdreg_hdregenccdbiasdis_bit;
        partial void Hdreg_Hdregenccdbiasdis_Write(bool a, bool b);
        partial void Hdreg_Hdregenccdbiasdis_Read(bool a, bool b);
        partial void Hdreg_Hdregenccdbiasdis_ValueProvider(bool a);
        ...
        protected IFlagRegisterField hdreg_ovrhdregfrcregmode_bit;
        partial void Hdreg_Ovrhdregfrcregmode_Write(bool a, bool b);
        partial void Hdreg_Ovrhdregfrcregmode_Read(bool a, bool b);
        partial void Hdreg_Ovrhdregfrcregmode_ValueProvider(bool a);
    
        protected IFlagRegisterField hdreg_ovrhdregccdbias_bit;
        partial void Hdreg_Ovrhdregccdbias_Write(bool a, bool b);
        partial void Hdreg_Ovrhdregccdbias_Read(bool a, bool b);
        partial void Hdreg_Ovrhdregccdbias_ValueProvider(bool a);
        ...
        protected IEnumRegisterField<BOD3SENSETRIM_BOD3SENSEBLKDLY> bod3sensetrim_bod3senseblkdly_field;
        partial void Bod3sensetrim_Bod3senseblkdly_Write(BOD3SENSETRIM_BOD3SENSEBLKDLY a, BOD3SENSETRIM_BOD3SENSEBLKDLY b);
        partial void Bod3sensetrim_Bod3senseblkdly_Read(BOD3SENSETRIM_BOD3SENSEBLKDLY a, BOD3SENSETRIM_BOD3SENSEBLKDLY b);
        partial void Bod3sensetrim_Bod3senseblkdly_ValueProvider(BOD3SENSETRIM_BOD3SENSEBLKDLY a);
    
        protected IFlagRegisterField bod3sensetrim_bode3senseenhysn_bit;
        partial void Bod3sensetrim_Bode3senseenhysn_Write(bool a, bool b);
        partial void Bod3sensetrim_Bode3senseenhysn_Read(bool a, bool b);
        partial void Bod3sensetrim_Bode3senseenhysn_ValueProvider(bool a);
        ...
        protected IValueRegisterField isbiastrim_isbiastrim1p2_field;
        partial void Isbiastrim_Isbiastrim1p2_Write(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim1p2_Read(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim1p2_ValueProvider(ulong a);
        ...
        protected IValueRegisterField isbiastrim_isbiastrim0p98_field;
        partial void Isbiastrim_Isbiastrim0p98_Write(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim0p98_Read(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim0p98_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiastrim_isbiastrim0p7_field;
        partial void Isbiastrim_Isbiastrim0p7_Write(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim0p7_Read(ulong a, ulong b);
        partial void Isbiastrim_Isbiastrim0p7_ValueProvider(ulong a);
        ...
        protected IFlagRegisterField anastatus_flbodmaskoncfgchg_bit;
        partial void Anastatus_Flbodmaskoncfgchg_Read(bool a, bool b);
        partial void Anastatus_Flbodmaskoncfgchg_ValueProvider(bool a);
        ...
        protected IFlagRegisterField anastatus_flregrdy_bit;
        partial void Anastatus_Flregrdy_Read(bool a, bool b);
        partial void Anastatus_Flregrdy_ValueProvider(bool a);
        ...
        protected IFlagRegisterField flreg_en_bit;
        partial void Flreg_En_Write(bool a, bool b);
        partial void Flreg_En_Read(bool a, bool b);
        partial void Flreg_En_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_disclamp_bit;
        partial void Flreg_Disclamp_Write(bool a, bool b);
        partial void Flreg_Disclamp_Read(bool a, bool b);
        partial void Flreg_Disclamp_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_enpulldn_bit;
        partial void Flreg_Enpulldn_Write(bool a, bool b);
        partial void Flreg_Enpulldn_Read(bool a, bool b);
        partial void Flreg_Enpulldn_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_em2dis_bit;
        partial void Flreg_Em2dis_Write(bool a, bool b);
        partial void Flreg_Em2dis_Read(bool a, bool b);
        partial void Flreg_Em2dis_ValueProvider(bool a);
    
        protected IValueRegisterField flreg_vtrim_field;
        partial void Flreg_Vtrim_Write(ulong a, ulong b);
        partial void Flreg_Vtrim_Read(ulong a, ulong b);
        partial void Flreg_Vtrim_ValueProvider(ulong a);
    
        protected IValueRegisterField flreg_ilmt_field;
        partial void Flreg_Ilmt_Write(ulong a, ulong b);
        partial void Flreg_Ilmt_Read(ulong a, ulong b);
        partial void Flreg_Ilmt_ValueProvider(ulong a);
    
        protected IEnumRegisterField<FLREG_SSRAMP> flreg_ssramp_field;
        partial void Flreg_Ssramp_Write(FLREG_SSRAMP a, FLREG_SSRAMP b);
        partial void Flreg_Ssramp_Read(FLREG_SSRAMP a, FLREG_SSRAMP b);
        partial void Flreg_Ssramp_ValueProvider(FLREG_SSRAMP a);
    
        protected IValueRegisterField flreg_cz_field;
        partial void Flreg_Cz_Write(ulong a, ulong b);
        partial void Flreg_Cz_Read(ulong a, ulong b);
        partial void Flreg_Cz_ValueProvider(ulong a);
    
        protected IFlagRegisterField flreg_enreg1v2_bit;
        partial void Flreg_Enreg1v2_Write(bool a, bool b);
        partial void Flreg_Enreg1v2_Read(bool a, bool b);
        partial void Flreg_Enreg1v2_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_ovren_bit;
        partial void Flreg_Ovren_Write(bool a, bool b);
        partial void Flreg_Ovren_Read(bool a, bool b);
        partial void Flreg_Ovren_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_ovrenbias_bit;
        partial void Flreg_Ovrenbias_Write(bool a, bool b);
        partial void Flreg_Ovrenbias_Read(bool a, bool b);
        partial void Flreg_Ovrenbias_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_ovrenlp_bit;
        partial void Flreg_Ovrenlp_Write(bool a, bool b);
        partial void Flreg_Ovrenlp_Read(bool a, bool b);
        partial void Flreg_Ovrenlp_ValueProvider(bool a);
    
        protected IFlagRegisterField flreg_ovroverrideen_bit;
        partial void Flreg_Ovroverrideen_Write(bool a, bool b);
        partial void Flreg_Ovroverrideen_Read(bool a, bool b);
        partial void Flreg_Ovroverrideen_ValueProvider(bool a);
        partial void Flreg_Write(uint a, uint b);
        partial void Flreg_Read(uint a, uint b);
        
        
        // Flbod - Offset : 0x4C
    
        protected IFlagRegisterField flbod_en_bit;
        partial void Flbod_En_Write(bool a, bool b);
        partial void Flbod_En_Read(bool a, bool b);
        partial void Flbod_En_ValueProvider(bool a);
    
        protected IFlagRegisterField flbod_bodmask_bit;
        partial void Flbod_Bodmask_Write(bool a, bool b);
        partial void Flbod_Bodmask_Read(bool a, bool b);
        partial void Flbod_Bodmask_ValueProvider(bool a);
    
        protected IFlagRegisterField flbod_em2dis_bit;
        partial void Flbod_Em2dis_Write(bool a, bool b);
        partial void Flbod_Em2dis_Read(bool a, bool b);
        partial void Flbod_Em2dis_ValueProvider(bool a);
    
        protected IValueRegisterField flbod_thres_field;
        partial void Flbod_Thres_Write(ulong a, ulong b);
        partial void Flbod_Thres_Read(ulong a, ulong b);
        partial void Flbod_Thres_ValueProvider(ulong a);
    
        protected IValueRegisterField flbod_hys_field;
        partial void Flbod_Hys_Write(ulong a, ulong b);
        partial void Flbod_Hys_Read(ulong a, ulong b);
        partial void Flbod_Hys_ValueProvider(ulong a);
    
        protected IFlagRegisterField flbod_forceflregrdy_bit;
        partial void Flbod_Forceflregrdy_Write(bool a, bool b);
        partial void Flbod_Forceflregrdy_Read(bool a, bool b);
        partial void Flbod_Forceflregrdy_ValueProvider(bool a);
    
        protected IFlagRegisterField flbod_enreg1v2_bit;
        partial void Flbod_Enreg1v2_Write(bool a, bool b);
        partial void Flbod_Enreg1v2_Read(bool a, bool b);
        partial void Flbod_Enreg1v2_ValueProvider(bool a);
    
        protected IFlagRegisterField flbod_ovren_bit;
        partial void Flbod_Ovren_Write(bool a, bool b);
        partial void Flbod_Ovren_Read(bool a, bool b);
        partial void Flbod_Ovren_ValueProvider(bool a);
    
        protected IFlagRegisterField flbod_ovroverrideen_bit;
        partial void Flbod_Ovroverrideen_Write(bool a, bool b);
        partial void Flbod_Ovroverrideen_Read(bool a, bool b);
        partial void Flbod_Ovroverrideen_ValueProvider(bool a);
        partial void Flbod_Write(uint a, uint b);
        partial void Flbod_Read(uint a, uint b);
        ...
        protected IValueRegisterField rev_ipversion_ipversion_field;
        partial void Rev_Ipversion_Ipversion_Read(ulong a, ulong b);
        partial void Rev_Ipversion_Ipversion_ValueProvider(ulong a);
        partial void Rev_Ipversion_Write(uint a, uint b);
        partial void Rev_Ipversion_Read(uint a, uint b);
        ...
        protected IFlagRegisterField ctrl_em2emulen_bit;
        partial void Ctrl_Em2emulen_Write(bool a, bool b);
        partial void Ctrl_Em2emulen_Read(bool a, bool b);
        partial void Ctrl_Em2emulen_ValueProvider(bool a);
        ...
        protected IFlagRegisterField testctrl_padfeedbackdis_bit;
        partial void Testctrl_Padfeedbackdis_Write(bool a, bool b);
        partial void Testctrl_Padfeedbackdis_Read(bool a, bool b);
        partial void Testctrl_Padfeedbackdis_ValueProvider(bool a);
        ...
        protected IEnumRegisterField<RSTCTRL_FLBODRMODE> rstctrl_flbodrmode_bit;
        partial void Rstctrl_Flbodrmode_Write(RSTCTRL_FLBODRMODE a, RSTCTRL_FLBODRMODE b);
        partial void Rstctrl_Flbodrmode_Read(RSTCTRL_FLBODRMODE a, RSTCTRL_FLBODRMODE b);
        partial void Rstctrl_Flbodrmode_ValueProvider(RSTCTRL_FLBODRMODE a);
        ...
        protected IFlagRegisterField rstcause_flbod_bit;
        partial void Rstcause_Flbod_Read(bool a, bool b);
        partial void Rstcause_Flbod_ValueProvider(bool a);
    
        protected IFlagRegisterField rstcause_setamper_bit;
        partial void Rstcause_Setamper_Read(bool a, bool b);
        partial void Rstcause_Setamper_ValueProvider(bool a);
        ...
        protected IValueRegisterField isoovr_rfdigiso_field;
        partial void Isoovr_Rfdigiso_Write(ulong a, ulong b);
        partial void Isoovr_Rfdigiso_Read(ulong a, ulong b);
        partial void Isoovr_Rfdigiso_ValueProvider(ulong a);
        partial void Isoovr_Write(uint a, uint b);
        partial void Isoovr_Read(uint a, uint b);
        ...
        protected IEnumRegisterField<PERIPHSTATUS_PWRDWNSTATUS> periphstatus_pwrdwnstatus_field;
        partial void Periphstatus_Pwrdwnstatus_Read(PERIPHSTATUS_PWRDWNSTATUS a, PERIPHSTATUS_PWRDWNSTATUS b);
        partial void Periphstatus_Pwrdwnstatus_ValueProvider(PERIPHSTATUS_PWRDWNSTATUS a);
        partial void Periphstatus_Write(uint a, uint b);
        partial void Periphstatus_Read(uint a, uint b);
        ...
        protected IFlagRegisterField isbiasctrl_isbiasperiod_em2periodx4_bit;
        partial void Isbiasctrl_Isbiasperiod_Em2periodx4_Write(bool a, bool b);
        partial void Isbiasctrl_Isbiasperiod_Em2periodx4_Read(bool a, bool b);
        partial void Isbiasctrl_Isbiasperiod_Em2periodx4_ValueProvider(bool a);
        ...
        protected IValueRegisterField isbiasctrl_isbiastempcomprate_r4refreshrate_field;
        partial void Isbiasctrl_Isbiastempcomprate_R4refreshrate_Write(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcomprate_R4refreshrate_Read(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcomprate_R4refreshrate_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_isbiastempcomprate_r5refreshrate_field;
        partial void Isbiasctrl_Isbiastempcomprate_R5refreshrate_Write(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcomprate_R5refreshrate_Read(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcomprate_R5refreshrate_ValueProvider(ulong a);
        ...
        protected IFlagRegisterField isbiasctrl_isbiaspfmrefreshcfg_s2roomtempdiv2_bit;
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_Write(bool a, bool b);
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_Read(bool a, bool b);
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2roomtempdiv2_ValueProvider(bool a);
    
        protected IFlagRegisterField isbiasctrl_isbiaspfmrefreshcfg_s2fastrfrshem2entryctrl_bit;
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_Write(bool a, bool b);
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_Read(bool a, bool b);
        partial void Isbiasctrl_Isbiaspfmrefreshcfg_S2fastrfrshem2entryctrl_ValueProvider(bool a);
        ...
        protected IValueRegisterField isbiasctrl_isbiasstatus_retregtemprange_field;
        partial void Isbiasctrl_Isbiasstatus_Retregtemprange_Read(ulong a, ulong b);
        partial void Isbiasctrl_Isbiasstatus_Retregtemprange_ValueProvider(ulong a);
        ...
        protected IEnumRegisterField<ISBIASCTRL_VSBTEMPCOMP_R4VSB> isbiasctrl_vsbtempcomp_r4vsb_field;
        partial void Isbiasctrl_Vsbtempcomp_R4vsb_Write(ISBIASCTRL_VSBTEMPCOMP_R4VSB a, ISBIASCTRL_VSBTEMPCOMP_R4VSB b);
        partial void Isbiasctrl_Vsbtempcomp_R4vsb_Read(ISBIASCTRL_VSBTEMPCOMP_R4VSB a, ISBIASCTRL_VSBTEMPCOMP_R4VSB b);
        partial void Isbiasctrl_Vsbtempcomp_R4vsb_ValueProvider(ISBIASCTRL_VSBTEMPCOMP_R4VSB a);
    
        protected IEnumRegisterField<ISBIASCTRL_VSBTEMPCOMP_R5VSB> isbiasctrl_vsbtempcomp_r5vsb_field;
        partial void Isbiasctrl_Vsbtempcomp_R5vsb_Write(ISBIASCTRL_VSBTEMPCOMP_R5VSB a, ISBIASCTRL_VSBTEMPCOMP_R5VSB b);
        partial void Isbiasctrl_Vsbtempcomp_R5vsb_Read(ISBIASCTRL_VSBTEMPCOMP_R5VSB a, ISBIASCTRL_VSBTEMPCOMP_R5VSB b);
        partial void Isbiasctrl_Vsbtempcomp_R5vsb_ValueProvider(ISBIASCTRL_VSBTEMPCOMP_R5VSB a);
        ...
        protected IValueRegisterField isbiasctrl_retregtempcomp_r4retreghstrim_field;
        partial void Isbiasctrl_Retregtempcomp_R4retreghstrim_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcomp_R4retreghstrim_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcomp_R4retreghstrim_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_retregtempcomp_r5retreghstrim_field;
        partial void Isbiasctrl_Retregtempcomp_R5retreghstrim_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcomp_R5retreghstrim_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcomp_R5retreghstrim_ValueProvider(ulong a);
        ...
        protected IValueRegisterField isbiasctrl_isbiastempcompthr2_r4tempthr_field;
        partial void Isbiasctrl_Isbiastempcompthr2_R4tempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcompthr2_R4tempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcompthr2_R4tempthr_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_isbiastempcompthr2_r5tempthr_field;
        partial void Isbiasctrl_Isbiastempcompthr2_R5tempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcompthr2_R5tempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Isbiastempcompthr2_R5tempthr_ValueProvider(ulong a);
        partial void Isbiasctrl_Isbiastempcompthr2_Write(uint a, uint b);
        partial void Isbiasctrl_Isbiastempcompthr2_Read(uint a, uint b);
        ...
        protected IValueRegisterField isbiasctrl_vsbtempcompthr2_r4vsbtempthr_field;
        partial void Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Vsbtempcompthr2_R4vsbtempthr_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_vsbtempcompthr2_r5vsbtempthr_field;
        partial void Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Vsbtempcompthr2_R5vsbtempthr_ValueProvider(ulong a);
        partial void Isbiasctrl_Vsbtempcompthr2_Write(uint a, uint b);
        partial void Isbiasctrl_Vsbtempcompthr2_Read(uint a, uint b);
        
        
        // Isbiasctrl_Retregtempcompthr - Offset : 0x10C
    
        protected IValueRegisterField isbiasctrl_retregtempcompthr_r1retregtempthr_field;
        partial void Isbiasctrl_Retregtempcompthr_R1retregtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R1retregtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R1retregtempthr_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_retregtempcompthr_r2retregtempthr_field;
        partial void Isbiasctrl_Retregtempcompthr_R2retregtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R2retregtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R2retregtempthr_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_retregtempcompthr_r3retregtempthr_field;
        partial void Isbiasctrl_Retregtempcompthr_R3retregtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R3retregtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr_R3retregtempthr_ValueProvider(ulong a);
        partial void Isbiasctrl_Retregtempcompthr_Write(uint a, uint b);
        partial void Isbiasctrl_Retregtempcompthr_Read(uint a, uint b);
        
        
        // Isbiasctrl_Retregtempcompthr2 - Offset : 0x110
    
        protected IValueRegisterField isbiasctrl_retregtempcompthr2_r4retregtempthr_field;
        partial void Isbiasctrl_Retregtempcompthr2_R4retregtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr2_R4retregtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr2_R4retregtempthr_ValueProvider(ulong a);
    
        protected IValueRegisterField isbiasctrl_retregtempcompthr2_r5retregtempthr_field;
        partial void Isbiasctrl_Retregtempcompthr2_R5retregtempthr_Write(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr2_R5retregtempthr_Read(ulong a, ulong b);
        partial void Isbiasctrl_Retregtempcompthr2_R5retregtempthr_ValueProvider(ulong a);
        partial void Isbiasctrl_Retregtempcompthr2_Write(uint a, uint b);
        partial void Isbiasctrl_Retregtempcompthr2_Read(uint a, uint b);
        
        
        // Misc_Qspi - Offset : 0x130
    
        protected IValueRegisterField misc_qspi_qspicoderegionbankswap_field;
        partial void Misc_Qspi_Qspicoderegionbankswap_Write(ulong a, ulong b);
        partial void Misc_Qspi_Qspicoderegionbankswap_Read(ulong a, ulong b);
        partial void Misc_Qspi_Qspicoderegionbankswap_ValueProvider(ulong a);
        partial void Misc_Qspi_Write(uint a, uint b);
        partial void Misc_Qspi_Read(uint a, uint b);
        ...
        protected IFlagRegisterField rootctrl_em2dis_bit;
        partial void Rootctrl_Em2dis_Write(bool a, bool b);
        partial void Rootctrl_Em2dis_Read(bool a, bool b);
        partial void Rootctrl_Em2dis_ValueProvider(bool a);
        ...
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdldreg_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdldreg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdldreg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdldreg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratddvddlebod_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddlebod_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdvlmthv_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdvlmthv_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratddvddbod_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddbod_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddbod_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddvddbod_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratddecbod_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratddecbod_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddecbod_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratddecbod_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdhdreg_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdhdreg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdhdreg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdhdreg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdretreg_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdretreg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdretreg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdretreg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdbod3sensetrim_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sensetrim_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdbod3sense_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdbod3sense_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdisbias_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbias_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbias_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbias_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdisbiastrim_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiastrim_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdisbiasvrefregtrim_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvrefregtrim_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdisbiasvreflvbodtrim_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdisbiasvreflvbodtrim_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdpfmbyp_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbyp_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdpfmbypctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpfmbypctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdflreg_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflreg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflreg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflreg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdflbod_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflbod_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflbod_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdflbod_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdpd1paretctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd1paretctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdpd0pwrctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdpd0pwrem2ctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdpd0pwrem2ctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdlock_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdlock_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdlock_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdlock_ValueProvider(bool a);
        ...
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdem4ctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdem4ctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdcmd_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdcmd_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdcmd_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdcmd_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd0_ratdtemplimits_bit;
        partial void Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd0_Ratdtemplimits_ValueProvider(bool a);
        ...
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdtemplimitsse_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtemplimitsse_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdtestctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdrmuctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdrmuctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisoovr_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisoovr_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisoovr_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisoovr_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratddelaycfg_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratddelaycfg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdtestlock_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestlock_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestlock_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdtestlock_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdauxctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdauxctrl_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiasconf_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasconf_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiascalovr_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiascalovr_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiasperiod_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasperiod_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiastempcomprate_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcomprate_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiaspfmrefreshcfg_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiaspfmrefreshcfg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiasrefreshcfg_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiasrefreshcfg_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiastempconst_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempconst_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdvsbtempcomp_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdvsbtempcomp_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdretregtempcomp_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdretregtempcomp_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd1_ratdisbiastempcompthr2_bit;
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd1_Ratdisbiastempcompthr2_ValueProvider(bool a);
        partial void Cfgdrpu_Cfgrpuratd1_Write(uint a, uint b);
        partial void Cfgdrpu_Cfgrpuratd1_Read(uint a, uint b);
        
        
        // Cfgdrpu_Cfgrpuratd2 - Offset : 0x194
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr_bit;
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd2_ratdvsbtempcompthr2_bit;
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdvsbtempcompthr2_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd2_ratdretregtempcompthr_bit;
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd2_ratdretregtempcompthr2_bit;
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdretregtempcompthr2_ValueProvider(bool a);
    
        protected IFlagRegisterField cfgdrpu_cfgrpuratd2_ratdqspi_bit;
        partial void Cfgdrpu_Cfgrpuratd2_Ratdqspi_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdqspi_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd2_Ratdqspi_ValueProvider(bool a);
        ...
        protected IFlagRegisterField cfgdrpu_cfgrpuratd3_ratdrootctrl_bit;
        partial void Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_Write(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_Read(bool a, bool b);
        partial void Cfgdrpu_Cfgrpuratd3_Ratdrootctrl_ValueProvider(bool a);
        partial void Cfgdrpu_Cfgrpuratd3_Write(uint a, uint b);
        partial void Cfgdrpu_Cfgrpuratd3_Read(uint a, uint b);
        ...
        protected enum Registers
        {
            ...
            Isbiasctrl_Retregtempcomp = 0xEC,
            Isbiasctrl_Isbiastempcompthr = 0xF8,
            Isbiasctrl_Isbiastempcompthr2 = 0xFC,
            Isbiasctrl_Vsbtempcompthr = 0x100,
            Isbiasctrl_Vsbtempcompthr2 = 0x108,
            Isbiasctrl_Retregtempcompthr = 0x10C,
            Isbiasctrl_Retregtempcompthr2 = 0x110,
            Misc_Qspi = 0x130,
            Rootctrl = 0x188,
            Cfgdrpu_Cfgrpuratd0 = 0x18C,
            Cfgdrpu_Cfgrpuratd1 = 0x190,
            Cfgdrpu_Cfgrpuratd2 = 0x194,
            Cfgdrpu_Cfgrpuratd3 = 0x198,
            ...
            Flreg_SET = 0x1040,
            Flbod_SET = 0x104C,
            Pd1paretctrl_SET = 0x1050,
            Pd0pwrctrl_SET = 0x1054,
            Pd0pwrem2ctrl_SET = 0x1058,
            Rev_Ipversion_SET = 0x105C,
            Lock_SET = 0x1060,
            If_SET = 0x1064,
            Ien_SET = 0x1068,
            Em4ctrl_SET = 0x106C,
            ...
            Isbiasctrl_Retregtempcomp_SET = 0x10EC,
            Isbiasctrl_Isbiastempcompthr_SET = 0x10F8,
            Isbiasctrl_Isbiastempcompthr2_SET = 0x10FC,
            Isbiasctrl_Vsbtempcompthr_SET = 0x1100,
            Isbiasctrl_Vsbtempcompthr2_SET = 0x1108,
            Isbiasctrl_Retregtempcompthr_SET = 0x110C,
            Isbiasctrl_Retregtempcompthr2_SET = 0x1110,
            Misc_Qspi_SET = 0x1130,
            Rootctrl_SET = 0x1188,
            Cfgdrpu_Cfgrpuratd0_SET = 0x118C,
            Cfgdrpu_Cfgrpuratd1_SET = 0x1190,
            Cfgdrpu_Cfgrpuratd2_SET = 0x1194,
            Cfgdrpu_Cfgrpuratd3_SET = 0x1198,
            ...
            Flreg_CLR = 0x2040,
            Flbod_CLR = 0x204C,
            Pd1paretctrl_CLR = 0x2050,
            Pd0pwrctrl_CLR = 0x2054,
            Pd0pwrem2ctrl_CLR = 0x2058,
            Rev_Ipversion_CLR = 0x205C,
            Lock_CLR = 0x2060,
            If_CLR = 0x2064,
            Ien_CLR = 0x2068,
            Em4ctrl_CLR = 0x206C,
            ...
            Isbiasctrl_Retregtempcomp_CLR = 0x20EC,
            Isbiasctrl_Isbiastempcompthr_CLR = 0x20F8,
            Isbiasctrl_Isbiastempcompthr2_CLR = 0x20FC,
            Isbiasctrl_Vsbtempcompthr_CLR = 0x2100,
            Isbiasctrl_Vsbtempcompthr2_CLR = 0x2108,
            Isbiasctrl_Retregtempcompthr_CLR = 0x210C,
            Isbiasctrl_Retregtempcompthr2_CLR = 0x2110,
            Misc_Qspi_CLR = 0x2130,
            Rootctrl_CLR = 0x2188,
            Cfgdrpu_Cfgrpuratd0_CLR = 0x218C,
            Cfgdrpu_Cfgrpuratd1_CLR = 0x2190,
            Cfgdrpu_Cfgrpuratd2_CLR = 0x2194,
            Cfgdrpu_Cfgrpuratd3_CLR = 0x2198,
            ...
            Flreg_TGL = 0x3040,
            Flbod_TGL = 0x304C,
            Pd1paretctrl_TGL = 0x3050,
            Pd0pwrctrl_TGL = 0x3054,
            Pd0pwrem2ctrl_TGL = 0x3058,
            Rev_Ipversion_TGL = 0x305C,
            Lock_TGL = 0x3060,
            If_TGL = 0x3064,
            Ien_TGL = 0x3068,
            Em4ctrl_TGL = 0x306C,
            ...
            Isbiasctrl_Retregtempcomp_TGL = 0x30EC,
            Isbiasctrl_Isbiastempcompthr_TGL = 0x30F8,
            Isbiasctrl_Isbiastempcompthr2_TGL = 0x30FC,
            Isbiasctrl_Vsbtempcompthr_TGL = 0x3100,
            Isbiasctrl_Vsbtempcompthr2_TGL = 0x3108,
            Isbiasctrl_Retregtempcompthr_TGL = 0x310C,
            Isbiasctrl_Retregtempcompthr2_TGL = 0x3110,
            Misc_Qspi_TGL = 0x3130,
            Rootctrl_TGL = 0x3188,
            Cfgdrpu_Cfgrpuratd0_TGL = 0x318C,
            Cfgdrpu_Cfgrpuratd1_TGL = 0x3190,
            Cfgdrpu_Cfgrpuratd2_TGL = 0x3194,
            Cfgdrpu_Cfgrpuratd3_TGL = 0x3198,
        }   
