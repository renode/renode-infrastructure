...
/*  WARNING: Auto-Generated Peripheral  -  DO NOT EDIT
    LFRCO, Generated on : 2025-07-25 14:31:10.515522
    LFRCO, ID Version : c5b974e8e30f414db1344f6c7175dc21.1 */
...
{
    public partial class SiLabs_LFRCO_1 : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        protected DoubleWordRegister GenerateHiprecisionRegister() => new DoubleWordRegister(this, 0x18E23645)
        ...
        // Trim - Offset : 0x38
        protected DoubleWordRegister GenerateTrimRegister() => new DoubleWordRegister(this, 0x4C002020)
            ...
            .WithValueField(24, 2, out trim_tempcob_field, 
                    valueProviderCallback: (_) => {
                        Trim_Tempcob_ValueProvider(_);
                        return trim_tempcob_field.Value;
                    },
            ...
            .WithValueField(27, 3, out trim_chopen_field, 
                    valueProviderCallback: (_) => {
                        Trim_Chopen_ValueProvider(_);
                        return trim_chopen_field.Value;
                    },
                    
                    writeCallback: (_, __) => Trim_Chopen_Write(_, __),
                    
                    readCallback: (_, __) => Trim_Chopen_Read(_, __),
                    name: "Chopen")
        ...
        protected DoubleWordRegister GenerateTrimhiprecRegister() => new DoubleWordRegister(this, 0xC602820)
            ...
            .WithValueField(24, 2, out trimhiprec_tempcobhiprec_field, 
                    valueProviderCallback: (_) => {
                        Trimhiprec_Tempcobhiprec_ValueProvider(_);
                        return trimhiprec_tempcobhiprec_field.Value;
                    },
            ...
            .WithValueField(27, 3, out trimhiprec_chopenhiprec_field, 
                    valueProviderCallback: (_) => {
                        Trimhiprec_Chopenhiprec_ValueProvider(_);
                        return trimhiprec_chopenhiprec_field.Value;
                    },
                    
                    writeCallback: (_, __) => Trimhiprec_Chopenhiprec_Write(_, __),
                    
                    readCallback: (_, __) => Trimhiprec_Chopenhiprec_Read(_, __),
                    name: "Chopenhiprec")
        ...
        protected DoubleWordRegister GenerateStepsizeRegister() => new DoubleWordRegister(this, 0x20380E)
        ...
        protected IValueRegisterField trim_tempcob_field;
        partial void Trim_Tempcob_Write(ulong a, ulong b);
        partial void Trim_Tempcob_Read(ulong a, ulong b);
        partial void Trim_Tempcob_ValueProvider(ulong a);
        ...
        protected IValueRegisterField trim_chopen_field;
        partial void Trim_Chopen_Write(ulong a, ulong b);
        partial void Trim_Chopen_Read(ulong a, ulong b);
        partial void Trim_Chopen_ValueProvider(ulong a);
        ...
        protected IValueRegisterField trimhiprec_tempcobhiprec_field;
        partial void Trimhiprec_Tempcobhiprec_Write(ulong a, ulong b);
        partial void Trimhiprec_Tempcobhiprec_Read(ulong a, ulong b);
        partial void Trimhiprec_Tempcobhiprec_ValueProvider(ulong a);
        ...
        protected IValueRegisterField trimhiprec_chopenhiprec_field;
        partial void Trimhiprec_Chopenhiprec_Write(ulong a, ulong b);
        partial void Trimhiprec_Chopenhiprec_Read(ulong a, ulong b);
        partial void Trimhiprec_Chopenhiprec_ValueProvider(ulong a);
