...
{
    public class SiLabs_SEMAILBOX_2 : IDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_SEMAILBOX_2(Machine machine, uint flashSize, uint flashPageSize, uint flashRegionSize,
                           uint flashCodeRegionStart, uint flashCodeRegionEnd, uint flashDataRegionStart, SiLabs_IKeyStorage ksu)
        {
