...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    ...
    {
        public SiLabs_DCDC_2(Machine machine) : base(machine)
        {
            SiLabs_DCDC_2_constructor();
        }
    }
}
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
namespace Antmicro.Renode.Peripherals.Miscellaneous.SiLabs
{
    public partial class SiLabs_DCDC_2 : BasicDoubleWordPeripheral, IKnownSize
    {
        public SiLabs_DCDC_2(Machine machine) : base(machine)
        {
            Define_Registers();
        ...
        partial void SiLabs_DCDC_2_Constructor();
