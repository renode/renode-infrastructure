...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    public class OpenTitan_AlertHandler: BasicDoubleWordPeripheral, IKnownSize, IGPIOReceiver
    {
        ...
        private const uint AlertsCount = 61;
        ...
        public enum Registers
        {
            ...
            AlertCause59                   = 0x3e0,
            AlertCause60                   = 0x3e4,
            LocalAlertRegisterWriteEnable0 = 0x3e8,
            LocalAlertRegisterWriteEnable1 = 0x3ec,
            LocalAlertRegisterWriteEnable2 = 0x3f0,
            LocalAlertRegisterWriteEnable3 = 0x3f4,
            LocalAlertRegisterWriteEnable4 = 0x3f8,
            LocalAlertRegisterWriteEnable5 = 0x3fc,
            LocalAlertRegisterWriteEnable6 = 0x400,
            LocalAlertEnable0              = 0x404,
            LocalAlertEnable1              = 0x408,
            LocalAlertEnable2              = 0x40c,
            LocalAlertEnable3              = 0x410,
            LocalAlertEnable4              = 0x414,
            LocalAlertEnable5              = 0x418,
            LocalAlertEnable6              = 0x41c,
            LocalAlertClass0               = 0x420,
            LocalAlertClass1               = 0x424,
            LocalAlertClass2               = 0x428,
            LocalAlertClass3               = 0x42c,
            LocalAlertClass4               = 0x430,
            LocalAlertClass5               = 0x434,
            LocalAlertClass6               = 0x438,
            LocalAlertCause0               = 0x43c,
            LocalAlertCause1               = 0x440,
            LocalAlertCause2               = 0x444,
            LocalAlertCause3               = 0x448,
            LocalAlertCause4               = 0x44c,
            LocalAlertCause5               = 0x450,
            LocalAlertCause6               = 0x454,
            ClassARegisterWriteEnable      = 0x458,
            ClassAControl                  = 0x45c,
            ClassAClearRegisterWriteEnable = 0x460,
            ClassAClear                    = 0x464,
            ClassAAccumulationCount        = 0x468,
            ClassAAccumulationThreshold    = 0x46C,
            ClassATimeoutCycle             = 0x470,
            ClassACrashdumpTrigger         = 0x474,
            ClassAPhase0Cycle              = 0x478,
            ClassAPhase1Cycle              = 0x47C,
            ClassAPhase2Cycle              = 0x480,
            ClassAPhase3Cycle              = 0x484,
            ClassAEscalationCount          = 0x488,
            ClassAState                    = 0x48C,
            ClassBRegisterWriteEnable      = 0x490,
            ClassBControl                  = 0x494,
            ClassBClearRegisterWriteEnable = 0x498,
            ClassBClear                    = 0x49C,
            ClassBAccumulationCount        = 0x4A0,
            ClassBAccumulationThreshold    = 0x4A4,
            ClassBTimeoutCycle             = 0x4A8,
            ClassBCrashdumpTrigger         = 0x4AC,
            ClassBPhase0Cycle              = 0x4B0,
            ClassBPhase1Cycle              = 0x4B4,
            ClassBPhase2Cycle              = 0x4B8,
            ClassBPhase3Cycle              = 0x4BC,
            ClassBEscalationCount          = 0x4C0,
            ClassBState                    = 0x4C4,
            ClassCRegisterWriteEnable      = 0x4C8,
            ClassCControl                  = 0x4CC,
            ClassCClearRegisterWriteEnable = 0x4D0,
            ClassCClear                    = 0x4D4,
            ClassCAccumulationCount        = 0x4D8,
            ClassCAccumulationThreshold    = 0x4DC,
            ClassCTimeoutCycle             = 0x4E0,
            ClassCCrashdumpTrigger         = 0x4E4,
            ClassCPhase0Cycle              = 0x4E8,
            ClassCPhase1Cycle              = 0x4EC,
            ClassCPhase2Cycle              = 0x4F0,
            ClassCPhase3Cycle              = 0x4F4,
            ClassCEscalationCount          = 0x4F8,
            ClassCState                    = 0x4FC,
            ClassDRegisterWriteEnable      = 0x500,
            ClassDControl                  = 0x504,
            ClassDClearRegisterWriteEnable = 0x508,
            ClassDClear                    = 0x50C,
            ClassDAccumulationCount        = 0x510,
            ClassDAccumulationThreshold    = 0x514,
            ClassDTimeoutCycle             = 0x518,
            ClassDCrashdumpTrigger         = 0x51C,
            ClassDPhase0Cycle              = 0x520,
            ClassDPhase1Cycle              = 0x524,
            ClassDPhase2Cycle              = 0x528,
            ClassDPhase3Cycle              = 0x52C,
            ClassDEscalationCount          = 0x530,
            ClassDState                    = 0x534,
        }
