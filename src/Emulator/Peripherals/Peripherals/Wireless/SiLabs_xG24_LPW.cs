...
namespace Antmicro.Renode.Peripherals.Wireless
{
    ...
    {
        public SiLabs_xG24_LPW(Machine machine, MappedMemory ram, CortexM sequencer, SiLabs_SYSRTC_1 sysrtc = null, bool pa0DbmSupport = false, bool pa10DbmSupport = false, bool pa20DbmSupport = false)
        {
            ...
            if (sysrtc != null)
            {
                sysrtc.CompareMatchGroup1Channel0 += PROTIMER_RtcCaptureCompareChannel0;
                sysrtc.CompareMatchGroup1Channel1 += PROTIMER_RtcCaptureCompareChannel1;
            }
...
#region PROTIMER methods
    ...
    public void PROTIMER_HandleChangedParams()
        ...
        private void PROTIMER_RtcCaptureCompareChannel0()
        {
            PROTIMER_RtcCaptureCompareChannel(0);
        }

        private void PROTIMER_RtcCaptureCompareChannel1()
        {
            PROTIMER_RtcCaptureCompareChannel(1);
        }

        private void PROTIMER_RtcCaptureCompareChannel(uint channel)
        {
            if (channel > 1)
            {
                this.Log(LogLevel.Error, "PROTIMER_RtcCaptureCompareChannel: invalid channel {0}", channel);
                return;
            }
        ...
        public void PROTIMER_RtcTrigger()
        {
...
#region Register enums
        ...
        private class PROTIMER_TimeoutCounter
        {
            ...
            private uint index;
            private SiLabs_xG24_LPW parent;
        ...
        {
            public BUFC_Buffer(SiLabs_xG24_LPW parent, Machine machine, uint index)
            {
                this.parent = parent;
                this.machine = machine;
                this.index = index;
