...
namespace Antmicro.Renode.Peripherals.Network
{
    ...
    {
        public LiteX_Ethernet_CSR32(Machine machine, int numberOfWriteSlots = 2, int numberOfReadSlots = 2) : base(machine)
        {
        ...
        private void DefineRegisters()
        {
            ...
            Registers.ReaderLength.Define(this)
                .WithValueField(0, 32, name: "reader_length",
                    writeCallback: (_, val) =>
                    {
                        readSlots[readerSlotNumber.Value].DataLength = val;
                    },
