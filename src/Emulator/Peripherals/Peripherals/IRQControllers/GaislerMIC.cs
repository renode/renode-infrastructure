...
namespace Antmicro.Renode.Peripherals.IRQControllers
{
    ...
    {
        public GaislerMIC(uint totalNumberCPUs = 1)
        {
        ...
        private static readonly uint maxNumberOfProcessors = 16;
        ...
        private readonly Dictionary<int, int>[] interrupts = new Dictionary<int, int>[maxNumberOfProcessors];
