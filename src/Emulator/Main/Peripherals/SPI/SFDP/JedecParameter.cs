...
namespace Antmicro.Renode.Peripherals.SPI.SFDP
{
    public class JedecParameter : SFDPParameter
    {
        ...
        {
            if(jedecParameterPacket.Read1s4s4sCode != null && jedecParameterPacket.Read1s4s4sCode != 0)
            {
        ...
        {
            if(jedecParameterPacket.Read1s1s4sCode != null && jedecParameterPacket.Read1s1s4sCode != 0)
            {
        ...
        {
            if(jedecParameterPacket.Read1s2s2sCode != null && jedecParameterPacket.Read1s2s2sCode != 0)
            {
        ...
        {
            if(jedecParameterPacket.Read1s1s2sCode != null && jedecParameterPacket.Read1s1s2sCode != 0)
            {
        ...
        {
            if(jedecParameterPacket.Read2s2s2sCode != null && jedecParameterPacket.Read2s2s2sCode != 0)
            {
        ...
        {
            if(jedecParameterPacket.Read4s4s4sCode != null && jedecParameterPacket.Read4s4s4sCode != 0)
            {
    ...
    public class JedecParameterPacket
    {
        ...
        public bool? Supports044; //TODO: why no s nor d
