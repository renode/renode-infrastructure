...
namespace Antmicro.Renode.Peripherals.Wireless
{
    ...
    public sealed class BLEMedium : IHasChildren<IMediumFunction>, IExternal, IConnectable<IRadio>, INetworkLogWireless
    {
        public BLEMedium()
        {
        ...
        public void AttachTo(IRadio radio)
        {
            ...
            {
                throw new RecoverableException("Cannot attach to the provided radio as it is already registered in this BLE medium.");
            }
        ...
        public void SetPosition(IRadio radio, decimal x, decimal y, decimal z)
        {
            ...
            else
            {
                ...
                this.Log(LogLevel.Error, $"Cannot set position for {name} as it is not registered in this BLE medium.");
            }
        }
