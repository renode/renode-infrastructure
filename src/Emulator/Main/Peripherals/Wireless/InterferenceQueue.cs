    ...
    public static class InterferenceQueue
    {
        ...
        public static void Add(IRadio sender, RadioPhyId phyId, int channel, int txPowerDbm, byte[] content)
        {
            ...
            if (entry != null)
            {
                ...
                {
                    throw new Exception("InterferenceQueue.Add: sender non-stale entry present");
                }
                Remove(sender);
            }
        ...
        public static void Remove(IRadio sender)
        {
            ...
            if (entry == null)
            {
                throw new Exception("InterferenceQueue.Remove: entry not found");
            }
        ...
        public static TimeInterval GetTxStartTime(IRadio sender)
        {
            ...
            if (entry == null)
            {
                throw new Exception("InterferenceQueue.GetTxStartTime: entry not found");
            }
