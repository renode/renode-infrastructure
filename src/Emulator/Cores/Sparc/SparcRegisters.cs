...
namespace Antmicro.Renode.Peripherals.CPU
{
    public partial class Sparc
    {
        ...
        {
            { SparcRegisters.R0,  new CPURegister(0, 32, true) },
            { SparcRegisters.R1,  new CPURegister(1, 32, true) },
            { SparcRegisters.R2,  new CPURegister(2, 32, true) },
            { SparcRegisters.R3,  new CPURegister(3, 32, true) },
            { SparcRegisters.R4,  new CPURegister(4, 32, true) },
            { SparcRegisters.R5,  new CPURegister(5, 32, true) },
            { SparcRegisters.R6,  new CPURegister(6, 32, true) },
            { SparcRegisters.R7,  new CPURegister(7, 32, true) },
            { SparcRegisters.R8,  new CPURegister(8, 32, true) },
            { SparcRegisters.R9,  new CPURegister(9, 32, true) },
            { SparcRegisters.R10,  new CPURegister(10, 32, true) },
            { SparcRegisters.R11,  new CPURegister(11, 32, true) },
            { SparcRegisters.R12,  new CPURegister(12, 32, true) },
            { SparcRegisters.R13,  new CPURegister(13, 32, true) },
            { SparcRegisters.R14,  new CPURegister(14, 32, true) },
            { SparcRegisters.R15,  new CPURegister(15, 32, true) },
            { SparcRegisters.R16,  new CPURegister(16, 32, true) },
            { SparcRegisters.R17,  new CPURegister(17, 32, true) },
            { SparcRegisters.R18,  new CPURegister(18, 32, true) },
            { SparcRegisters.R19,  new CPURegister(19, 32, true) },
            { SparcRegisters.R20,  new CPURegister(20, 32, true) },
            { SparcRegisters.R21,  new CPURegister(21, 32, true) },
            { SparcRegisters.R22,  new CPURegister(22, 32, true) },
            { SparcRegisters.R23,  new CPURegister(23, 32, true) },
            { SparcRegisters.R24,  new CPURegister(24, 32, true) },
            { SparcRegisters.R25,  new CPURegister(25, 32, true) },
            { SparcRegisters.R26,  new CPURegister(26, 32, true) },
            { SparcRegisters.R27,  new CPURegister(27, 32, true) },
            { SparcRegisters.R28,  new CPURegister(28, 32, true) },
            { SparcRegisters.R29,  new CPURegister(29, 32, true) },
            { SparcRegisters.R30,  new CPURegister(30, 32, true) },
            { SparcRegisters.R31,  new CPURegister(31, 32, true) },
            { SparcRegisters.PSR,  new CPURegister(32, 32, true) },
            { SparcRegisters.TBR,  new CPURegister(33, 32, true) },
            { SparcRegisters.Y,  new CPURegister(34, 32, true) },
            { SparcRegisters.PC,  new CPURegister(35, 32, true) },
            { SparcRegisters.NPC,  new CPURegister(36, 32, true) },
            { SparcRegisters.ASR16,  new CPURegister(37, 32, true) },
            { SparcRegisters.ASR17,  new CPURegister(38, 32, true) },
            { SparcRegisters.ASR18,  new CPURegister(39, 32, true) },
            { SparcRegisters.ASR19,  new CPURegister(40, 32, true) },
            { SparcRegisters.ASR20,  new CPURegister(41, 32, true) },
            { SparcRegisters.ASR21,  new CPURegister(42, 32, true) },
            { SparcRegisters.ASR22,  new CPURegister(43, 32, true) },
            { SparcRegisters.ASR23,  new CPURegister(44, 32, true) },
            { SparcRegisters.ASR24,  new CPURegister(45, 32, true) },
            { SparcRegisters.ASR25,  new CPURegister(46, 32, true) },
            { SparcRegisters.ASR26,  new CPURegister(47, 32, true) },
            { SparcRegisters.ASR27,  new CPURegister(48, 32, true) },
            { SparcRegisters.ASR28,  new CPURegister(49, 32, true) },
            { SparcRegisters.ASR29,  new CPURegister(50, 32, true) },
            { SparcRegisters.ASR30,  new CPURegister(51, 32, true) },
            { SparcRegisters.ASR31,  new CPURegister(52, 32, true) },
            { SparcRegisters.WIM,  new CPURegister(53, 32, true) },
        };
    }
