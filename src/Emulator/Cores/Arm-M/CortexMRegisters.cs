...
namespace Antmicro.Renode.Peripherals.CPU
{
    public partial class CortexM
    {
        ...
        {
            { CortexMRegisters.R0,  new CPURegister(0, 32, true) },
            { CortexMRegisters.R1,  new CPURegister(1, 32, true) },
            { CortexMRegisters.R2,  new CPURegister(2, 32, true) },
            { CortexMRegisters.R3,  new CPURegister(3, 32, true) },
            { CortexMRegisters.R4,  new CPURegister(4, 32, true) },
            { CortexMRegisters.R5,  new CPURegister(5, 32, true) },
            { CortexMRegisters.R6,  new CPURegister(6, 32, true) },
            { CortexMRegisters.R7,  new CPURegister(7, 32, true) },
            { CortexMRegisters.R8,  new CPURegister(8, 32, true) },
            { CortexMRegisters.R9,  new CPURegister(9, 32, true) },
            { CortexMRegisters.R10,  new CPURegister(10, 32, true) },
            { CortexMRegisters.R11,  new CPURegister(11, 32, true) },
            { CortexMRegisters.R12,  new CPURegister(12, 32, true) },
            { CortexMRegisters.SP,  new CPURegister(13, 32, true) },
            { CortexMRegisters.LR,  new CPURegister(14, 32, true) },
            { CortexMRegisters.PC,  new CPURegister(15, 32, true) },
