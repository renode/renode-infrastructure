...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    {
        public Ri5cy(Machine machine, IRiscVTimeProvider timeProvider = null, uint hartId = 0, PrivilegeArchitecture privilegeArchitecture = PrivilegeArchitecture.Priv1_10, Endianess endianness = Endianess.LittleEndian, string cpuType = "rv32imc") : base(timeProvider, cpuType, machine, hartId, privilegeArchitecture, endianness)
        {
