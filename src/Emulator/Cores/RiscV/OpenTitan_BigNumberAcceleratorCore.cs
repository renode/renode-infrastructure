...
namespace Antmicro.Renode.Peripherals.CPU
{
    public class OpenTitan_BigNumberAcceleratorCore : RiscV32, IOpenTitan_BigNumberAcceleratorCore
    {
        ...
        {
            ParseRTypeFields(opcode, out _, out _, out var wrs1, out var wrs2, out _, out _, out _);
        ...
        {
            ParseRTypeFields(opcode, out var f3, out var wrd, out var wrs1, out var wrs2, out _, out _, out var flagGroup);
        ...
        {
            ParseRTypeFields(opcode, out var _, out var wrd, out var wrs1, out var wrs2, out _, out _, out var flagGroup);
        ...
        {
            ParseRTypeFields(opcode, out var _, out var wrd, out var wrs1, out var wrs2, out _, out _, out _);
        ...
        {
            ParseRTypeFields(opcode, out var f3, out var wrd, out var wrs1, out _, out _, out _, out var flagGroup);
        ...
        {
            ParseSTypeFields(opcode, out var _, out var grs, out var grd, out var _, out var _, out var incrementRd);
        ...
        {
            ParseRTypeFields(opcode, out _, out var wrd, out var wrs, out _, out _, out _, out _);
            wideDataRegisters[wrd].SetTo(wideDataRegisters[wrs].AsBigInteger);
        }
