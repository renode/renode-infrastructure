...
uint32_t kvm_io_port_read_byte(uint32_t address);
uint32_t kvm_io_port_read_word(uint32_t address);
uint32_t kvm_io_port_read_double_word(uint32_t address);

void kvm_io_port_write_byte(uint32_t address, uint32_t value);
void kvm_io_port_write_word(uint32_t address, uint32_t value);
void kvm_io_port_write_double_word(uint32_t address, uint32_t value);
